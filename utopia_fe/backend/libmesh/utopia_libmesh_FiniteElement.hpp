...
namespace utopia {
    ...
    public:
        ...
        AssemblyContext<LIBMESH_TAG> &ctx() { return ctx_; }

        const AssemblyContext<LIBMESH_TAG> &ctx() const { return ctx_; }
        ...
        inline static std::string get_class() { return "FiniteElement"; }
