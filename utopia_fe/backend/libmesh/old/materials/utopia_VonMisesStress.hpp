...
namespace utopia {
    ...
    public:
        ...
        static double apply_2(const LMDenseMatrix &stress) {
            ...
            double result = 0.5 * (stress.get(0, 0) - stress.get(1, 1)) * (stress.get(0, 0) - stress.get(1, 1)) +
        ...
        static double apply_3(const LMDenseMatrix &stress) {
            ...
            double result = 0.5 * (stress.get(0, 0) - stress.get(0, 1)) * (stress.get(0, 0) - stress.get(0, 1)) +
                            3.0 * stress.get(0, 1) * stress.get(0, 1);

            result += 0.5 * (stress.get(2, 2) - stress.get(0, 1)) * (stress.get(2, 2) - stress.get(0, 1)) +
                      3.0 * stress.get(2, 1) * stress.get(2, 1);
            result += 0.5 * (stress.get(2, 2) - stress.get(0, 0)) * (stress.get(2, 2) - stress.get(0, 0)) +
                      3.0 * stress.get(2, 0) * stress.get(2, 0);
