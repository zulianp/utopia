...
namespace utopia {
	...
	void element_assemble_expression_v(const libMesh::MeshBase::const_element_iterator &it, const Expr &expr, GlobalMatrix &mat, GlobalVector &vec, const bool apply_constraints = true)
	{
	...
	template<class FunctionSpaceT, class Left, class Right, class Matrix, class Vector>
	void assemble_expression_v(const Equality<Left, Right> &equation, Matrix &mat, Vector &vec, const bool apply_constraints = true)
	{
