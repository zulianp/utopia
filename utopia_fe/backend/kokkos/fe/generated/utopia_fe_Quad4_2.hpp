...
T x2 = (1.0/4.0)*y - 0.25;
T x3 = (1.0/4.0)*y + 0.25;
measure_value = -(px[0]*x0 - px[1]*x1 + px[2]*x1 - px[3]*x0)*(py[0]*x2 - py[1]*x2 + py[2]*x3 - py[3]*x3) + (px[0]*x2 - px[1]*x2 + px[2]*x3 - px[3]*x3)*(py[0]*x0 - py[1]*x1 + py[2]*x1 - py[3]*x0);
...
T x46 = 0.25*x29;
T x47 = 0.25*x42;
T x48 = 2.0*sqrt(-px[0]*x22*x32 - px[1]*x22*x36 - px[1]*x31 - px[2]*px[3]*x30 - px[2]*x22*x38 + px[2]*x31 - px[2]*x35 - px[3]*x22*x40 - px[3]*x31 + px[3]*x35 - py[0]*x34*x39 - py[1]*x34*x41 - py[1]*x44 - py[2]*py[3]*x43 - py[2]*x33*x34 + py[2]*x44 - py[2]*x45 - py[3]*x34*x37 - py[3]*x44 + py[3]*x45 + x0*x17 + x0*x19 + x0*x21 - x0*x23 - x1*x11 + x1*x19 + x1*x23 - x1*x26 + x1*x8 + x10*x11 + x10*x14 + x10*x15 - x10*x3 - x10*x4 - x10*x5 + x11*x17 - x11*x19 - x12*x17 + x12*x19 - x12*x7 + x13*x3 + x13*x4 + x13*x5 - x14*x2 + x14*x21 + x14*x24 - x14*x27 + x14*x28 - x15*x21 + x15*x24 + x15*x27 + 0.5*x15*x7 - x15*x8 - x16*x8 + x17*x4 + x17*x7 - x18*x2 + x19*x4 + x2*x23 + x2*x7 - x20*x7 + x21*x3 + x21*x5 - x23*x3 - x23*x4 - x23*x5 + x23*x7 + x23*x8 - x24*x3 - x24*x5 + x25*x3 + x25*x5 + x27*x3 + x27*x4 + x27*x5 - x28*x7 + 0.25*x32*x33 + x32*x47 + x33*x46 + 0.25*x36*x37 + x36*x47 + x37*x46 + 0.25*x38*x39 + x38*x47 + x39*x46 + 0.25*x40*x41 + x40*x47 + x41*x46);
T x49 = px[1]*py[0];
T x50 = -px[2]*py[3] + px[3]*py[2];
x = (px[3]*py[0] - x11 + x12 + x14 - x15 - x16 + x18 - x2 + x20 - x26 - x48 - x9)/(x0 + x1 - x2 - x3 + x6 + x9);
y = (px[0]*py[1] + x11 - x12 - x14 + x15 + x16 - x18 - x20 + x26 - x48 - x49 - x50)/(px[0]*py[1] - x0 + x3 - x49 + x50 + x6);
			}
...
f[2] = x4*x5;
f[3] = x1*x5;
measure_value = -((1.0/4.0)*x10 - 1.0/4.0*x11 + (1.0/4.0)*x7 - 1.0/4.0*x9)*((1.0/4.0)*x13 - 1.0/4.0*x14 + (1.0/4.0)*x16 - 1.0/4.0*x17) + ((1.0/4.0)*x18 - 1.0/4.0*x19 + (1.0/4.0)*x20 - 1.0/4.0*x21)*((1.0/4.0)*x22 - 1.0/4.0*x23 + (1.0/4.0)*x24 - 1.0/4.0*x25);
gx[0] = x32*(x27 + x29);
gy[0] = x32*(-x33 - x34);
gx[1] = x32*(-x29 - x35);
gy[1] = x32*(x34 + x36);
