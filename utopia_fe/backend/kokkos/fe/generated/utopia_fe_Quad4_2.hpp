...
//	- Subexpressions: 0
measure_value = -px[0]*py[1]*y + px[0]*py[1] - px[0]*py[2]*x + px[0]*py[2]*y + px[0]*py[3]*x - px[0]*py[3]*y + px[1]*py[0]*y - px[1]*py[0] + px[1]*py[2]*x - px[1]*py[3]*x + px[2]*py[0]*x - px[2]*py[0]*y - px[2]*py[1]*x - px[3]*py[0]*x + px[3]*py[0]*y + px[3]*py[1]*x;
...
T x7 = py[0]*y;
T x8 = py[2]*y;
T x9 = 1.0/(-px[0]*x1 + px[0]*x3 + px[0]*x6 - px[0]*x8 + px[1]*x1 - px[1]*x3 + px[2]*x0 - px[2]*x2 + px[2]*x7 - px[3]*x0 + px[3]*x2 - px[3]*x7 - x4*y + x4 + x5*y - x5);
...
T x65 = py[0]*x48;
T x66 = 2*py[3];
T x67 = sqrt(px[0]*px[2]*x51 + px[0]*x53 + px[1]*x21*x43 - px[2]*py[2]*x32 - px[2]*x34*x41 - 4*px[3]*py[3]*x4 - px[3]*x21*x47 + px[3]*x41*x49 + py[0]*py[2]*x62 + py[0]*x60 + py[1]*x46*x55 + py[2]*x20*x38 - py[2]*x48*x66 + 2*py[2]*x65 - py[3]*x42*x55 + py[3]*x48*x63 - tx*x53 - ty*x60 - 4*x0*x12 + x0*x14 + 2*x0*x18 + x0*x22 - x0*x29 - x0*x32 + x0*x35 - x0*x37 + x1*x26 - x10*x27 + x11*x18 - x11*x19 + x11*x4 + x11*x6 + x11*x7 - x13*x18 + x13*x19 + x13*x5 + x13*x6 + x13*x7 + x14*x17 - x14*x19 - x15*x27 - x15*x36 - x15*x9 - 6*x16*x2 - x16*x31 + x16*x33 + x16*x35 + x16*x36 + x16*x37 + 4*x16*x5 + x16*x9 - x17*x37 + x18*x25 - x18*x26 + x18*x9 + x19*x25 + x19*x32 + x19*x9 + x20*x27 + 6*x20*x4 + x22*x28 + x22*x3 - x22*x4 - x22*x5 - x22*x6 - x22*x7 + x23*x24 + x24*x32 + x25*x28 - x25*x6 - x25*x7 + x28*x37 - x29*x3 - x29*x5 - x30*x33 + 4*x30*x7 - x31*x5 + x31*x6 - x34*x50 - x37*x7 + x38*x50 + x39*x40 + x39*x41 - x39*x56 + x40*x46 + x40*x48 + x41*x42 + x41*x44 + x41*x46 - x41*x57 + x42*x43 + x43*x44 + x43*x48 - x43*x57 - x43*x58 + x44*x45 + x45*x48 - x45*x58 + x46*x47 - x46*x56 - x46*x64 + x47*x48 - x48*x64 - x49*x50 - x5*x9 - x51*x54 - x52*x54 - x59*x61 - x6*x9 - x61*x62 - x63*x65 - x65*x66 - x7*x9);
T x68 = -x4 + x6;
T x69 = px[1]*py[0];
x = (1.0/2.0)*(-x10 + x12 - x15 + x16 - x17 - x18 + x19 + x20 - x23 + x28 - x30 + x32 + x5 - x67 - x68 - x7)/(x0 + x1 - x2 - x3 + x8);
y = (1.0/2.0)*(2*px[0]*py[1] + x10 - x12 + x15 - x16 + x17 + x18 - x19 - x20 + x23 - x28 + x30 - x32 - x67 - 2*x69 - x8)/(px[0]*py[1] - x1 + x2 + x68 - x69);
			}
...
T x12 = py[0]*y;
T x13 = py[2]*y;
T x14 = 1.0/(px[0]*x11 - px[0]*x13 - px[0]*x4 + px[0]*x6 + px[1]*x4 - px[1]*x6 + px[2]*x12 + px[2]*x3 - px[2]*x5 - px[3]*x12 - px[3]*x3 + px[3]*x5 + x10*y - x10 - x9*y + x9);
...
T x8 = py[1]*x;
T x9 = py[0]*x;
T x10 = px[0]*py[1]*y - px[0]*py[1] - px[0]*py[2]*y - px[0]*py[3]*x + px[0]*x4 + px[0]*x5 - px[1]*py[0]*y + px[1]*py[0] - px[1]*py[2]*x + px[1]*x6 - px[2]*py[0]*x + px[2]*x7 + px[2]*x8 - px[3]*py[0]*y - px[3]*py[1]*x + px[3]*x9;
