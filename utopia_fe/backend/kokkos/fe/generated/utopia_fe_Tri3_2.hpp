...
//	- Subexpressions: 0
measure_value = px[0]*py[1] - px[0]*py[2] - px[1]*py[0] + px[1]*py[2] + px[2]*py[0] - px[2]*py[1];
...
T x0 = 1.0/(px[0]*py[1] - px[0]*py[2] - px[1]*py[0] + px[1]*py[2] + px[2]*py[0] - px[2]*py[1]);
...
T x0 = -py[2];
T x1 = 1.0/(px[0]*py[1] - px[0]*py[2] - px[1]*py[0] + px[1]*py[2] + px[2]*py[0] - px[2]*py[1]);
T x2 = -px[2];
gx[0] = x1*(py[1] + x0);
gy[0] = x1*(-px[1] - x2);
gx[1] = x1*(-py[0] - x0);
