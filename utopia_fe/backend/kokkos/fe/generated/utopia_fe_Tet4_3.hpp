...
T x30 = 1.0/(pz[0]*x23 - pz[1]*x15 + pz[1]*x17 + pz[1]*x8 + pz[2]*x21 - pz[2]*x23 + pz[3]*x20 + pz[3]*x22 - pz[3]*x26 + x18 - x25 - x27 - x28 + x29);
T x31 = px[1]*ty;
T x32 = py[1]*tx;
T x33 = -pz[0]*x31 + pz[0]*x32 + pz[1]*x3 - pz[1]*x9 + tz*x20 - tz*x24;
x = x30*(-pz[2]*x12 + pz[2]*x2 - pz[3]*x0 + pz[3]*x5 - tz*x15 + tz*x8 + x1 - x10 - x11 - x14 + x18 + x19 + x4 + x7);
y = x30*(px[0]*py[3]*pz[1] + px[1]*py[0]*pz[3] + px[1]*py[3]*tz + px[3]*py[1]*pz[0] + px[3]*pz[1]*ty + py[1]*pz[3]*tx - pz[1]*x2 - pz[3]*x31 - tz*x23 - x19 - x25 - x27 - x28 - x33);
z = x30*(pz[1]*x0 - pz[1]*x5 + pz[2]*x31 - pz[2]*x32 + tz*x22 - tz*x26 - x1 + x10 + x11 + x14 + x29 + x33 - x4 - x7);
			}
