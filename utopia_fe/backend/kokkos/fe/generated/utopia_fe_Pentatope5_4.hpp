    ...
    namespace kernels {
        ...
        public:
            ...
            UTOPIA_FUNCTION static void jacobian_inverse(
                ...
                J_inv[15] =
                    x36 * (x1 * x18 * x33 - x10 * x19 * x33 + x11 * x32 - x14 * x32 - x18 * x23 * x9 + x19 * x23 * x6);
            }
            ...
            UTOPIA_FUNCTION static void inverse_transform(
                ...
                T x74 = x27 * x38;
                T x75 = x33 * x41;
                T x76 = x1 * x15 - x1 * x6 - x10 * x54 + x10 * x61 - x13 * x15 + x13 * x6 - x17 * x19 + x17 * x8 +
                        x19 * x3 + x21 * x54 - x21 * x61 - x24 * x31 + x24 * x47 + x28 * x49 - x28 * x56 - x3 * x8 +
                        x31 * x45 - x34 * x36 + x34 * x43 + x36 * x41 - x38 * x49 + x38 * x56 - x41 * x43 - x45 * x47;
                T x77 = -x1 * x12 + x1 * x23 + x12 * x13 - x13 * x23 - x16 * x54 + x16 * x61 - x19 * x20 + x19 * x9 +
                        x20 * x8 - x25 * x49 + x25 * x56 - x27 * x31 + x27 * x47 + x31 * x37 - x32 * x34 + x32 * x41 +
                        x34 * x40 - x37 * x47 + x4 * x54 - x4 * x61 - x40 * x41 + x44 * x49 - x44 * x56 - x8 * x9;
                T x78 = pt[0] * px[1];
                T x79 = py[1] * pz[4];
                T x80 = py[2] * pz[1];
                T x81 = pt[1] * px[0];
                ...
                T x104 = x20 * x91;
                T x105 = x33 * x87;
                T x106 = x15 * x78 - x15 * x81 - x17 * x83 + x17 * x89 - x24 * x88 + x24 * x93 + x3 * x83 - x3 * x89 +
                         x36 * x87 - x36 * x92 - x43 * x87 + x43 * x92 + x45 * x88 - x45 * x93 - x49 * x79 + x49 * x85 +
                         x54 * x84 - x54 * x91 + x56 * x79 - x56 * x85 - x6 * x78 + x6 * x81 - x61 * x84 + x61 * x91;
                T x107 = -x12 * x78 + x12 * x81 - x20 * x83 + x20 * x89 + x23 * x78 - x23 * x81 - x27 * x88 +
                         x27 * x93 + x32 * x87 - x32 * x92 + x37 * x88 - x37 * x93 - x40 * x87 + x40 * x92 - x49 * x80 +
                         x49 * x90 - x54 * x82 + x54 * x86 + x56 * x80 - x56 * x90 + x61 * x82 - x61 * x86 + x83 * x9 -
                         x89 * x9;
                T x108 =
                    1.0 / (x0 * x56 + x0 * x78 + x0 * x83 - x0 * x89 - x100 - x101 - x102 - x103 - x104 - x105 + x106 +
                           x107 + x12 * x24 - x12 * x84 + x12 * x91 + x15 * x27 + x15 * x82 - x15 * x86 + x17 * x40 +
                           x17 * x82 + x20 * x36 + x20 * x84 + x23 * x45 + x23 * x84 - x23 * x91 + x24 * x80 +
                           x27 * x85 + x3 * x32 + x3 * x86 + x30 * x61 + x30 * x87 + x30 * x88 - x30 * x93 - x32 * x79 +
                           x32 * x85 + x33 * x54 - x33 * x88 + x33 * x92 + x33 * x93 + x36 * x80 - x36 * x90 +
                           x37 * x6 + x37 * x79 + x40 * x79 - x40 * x85 - x43 * x80 + x43 * x9 + x43 * x90 + x45 * x90 -
                           x48 + x49 * x7 - x50 - x51 - x52 - x53 - x55 - x57 - x58 - x59 - x6 * x82 + x6 * x86 - x60 -
                           x62 - x63 + x7 * x81 - x7 * x83 + x7 * x89 + x9 * x91 - x94 - x95 - x96 - x97 - x98 - x99);
                T x109 = x1 * x93;
                T x110 = px[1] * tt;
                T x111 = x110 * x54;
                T x112 = x8 * x92;
                ...
                T x135 = x41 * x83;
                T x136 = x121 * x56;
                T x137 = -x1 * x79 + x1 * x85 + x10 * x87 - x10 * x92 - x110 * x17 + x110 * x3 + x114 * x17 -
                         x114 * x3 + x119 * x24 - x119 * x45 - x121 * x24 + x121 * x45 + x13 * x79 - x13 * x85 -
                         x21 * x87 + x21 * x92 - x28 * x78 + x28 * x81 - x34 * x84 + x34 * x91 + x38 * x78 - x38 * x81 +
                         x41 * x84 - x41 * x91;
                T x138 = -x1 * x80 + x1 * x90 - x110 * x20 + x110 * x9 + x114 * x20 - x114 * x9 + x119 * x27 -
                         x119 * x37 - x121 * x27 + x121 * x37 + x13 * x80 - x13 * x90 + x16 * x87 - x16 * x92 +
                         x25 * x78 - x25 * x81 + x34 * x82 - x34 * x86 - x4 * x87 + x4 * x92 - x41 * x82 + x41 * x86 -
                         x44 * x78 + x44 * x81;
                x = x108 *
                    (pt[0] * px[2] * py[4] * pz[3] + pt[0] * px[3] * py[2] * pz[4] + pt[0] * px[4] * py[3] * pz[2] +
                     pt[2] * px[0] * py[3] * pz[4] + pt[2] * px[3] * py[4] * pz[0] + pt[2] * px[3] * pz[4] * ty +
                     pt[2] * px[4] * py[0] * pz[3] + pt[2] * px[4] * py[3] * tz + pt[2] * py[4] * pz[3] * tx +
                     pt[3] * px[0] * py[4] * pz[2] + pt[3] * px[2] * py[0] * pz[4] + pt[3] * px[2] * py[4] * tz +
                     pt[3] * px[4] * py[2] * pz[0] + pt[3] * px[4] * pz[2] * ty + pt[3] * py[2] * pz[4] * tx +
                     pt[4] * px[0] * py[2] * pz[3] + pt[4] * px[2] * py[3] * pz[0] + pt[4] * px[2] * pz[3] * ty +
                     pt[4] * px[3] * py[0] * pz[2] + pt[4] * px[3] * py[2] * tz + pt[4] * py[3] * pz[2] * tx +
                     px[2] * py[3] * pz[4] * tt + px[3] * py[4] * pz[2] * tt + px[4] * py[2] * pz[3] * tt - x0 * x19 -
                     x10 * x12 - x11 - x14 - x15 * x16 - x18 - x2 - x21 * x23 - x22 - x25 * x36 - x26 - x28 * x32 -
                     x29 - x30 * x31 - x33 * x47 - x35 - x38 * x40 - x39 - x4 * x6 - x42 - x43 * x44 - x46 - x48 - x5 -
                     x50 - x51 - x52 - x53 - x55 - x57 - x58 - x59 - x60 - x62 - x63 + x64 + x65 + x66 + x67 + x68 +
                     x69 - x7 * x8 + x70 + x71 + x72 + x73 + x74 + x75 - x76 - x77);
                y = x108 *
                    (x10 * x88 - x10 * x93 + x106 + x109 - x110 * x15 + x110 * x6 + x111 + x112 + x113 + x114 * x15 -
                     ...
                     x136 + x137 - x19 * x79 + x19 * x85 - x21 * x88 + x21 * x93 - x28 * x83 + x28 * x89 + x31 * x84 -
                     x31 * x91 + x38 * x83 - x38 * x89 - x47 * x84 + x47 * x91 + x76 + x79 * x8 - x8 * x85);
                z = x108 *
                    (pt[0] * px[1] * py[4] * pz[2] + pt[0] * px[2] * py[1] * pz[4] + pt[0] * px[4] * py[2] * pz[1] +
                     pt[1] * px[0] * py[2] * pz[4] + pt[1] * px[2] * py[4] * pz[0] + pt[1] * px[2] * pz[4] * ty +
                     pt[1] * px[4] * py[0] * pz[2] + pt[1] * px[4] * py[2] * tz + pt[1] * py[4] * pz[2] * tx +
                     pt[2] * px[0] * py[4] * pz[1] + pt[2] * px[1] * py[0] * pz[4] + pt[2] * px[1] * py[4] * tz +
                     pt[2] * px[4] * py[1] * pz[0] + pt[2] * px[4] * pz[1] * ty + pt[2] * py[1] * pz[4] * tx +
                     pt[4] * px[0] * py[1] * pz[2] + pt[4] * px[1] * py[2] * pz[0] + pt[4] * px[1] * pz[2] * ty +
                     pt[4] * px[2] * py[0] * pz[1] + pt[4] * px[2] * py[1] * tz + pt[4] * py[2] * pz[1] * tx +
                     px[1] * py[2] * pz[4] * tt + px[2] * py[4] * pz[1] * tt + px[4] * py[1] * pz[2] * tt - x0 * x110 -
                     x10 * x80 - x100 - x101 - x102 - x103 - x104 - x105 + x11 - x114 * x7 - x119 * x33 - x121 * x30 -
                     x137 - x138 + x14 - x16 * x85 + x18 + x2 - x21 * x90 + x22 - x25 * x84 + x26 - x28 * x86 + x29 +
                     x35 - x38 * x82 + x39 - x4 * x79 + x42 - x44 * x91 + x46 + x5 - x64 - x65 - x66 - x67 - x68 - x69 -
                     x70 - x71 - x72 - x73 - x74 - x75 - x94 - x95 - x96 - x97 - x98 - x99);
                t = x108 *
                    (x107 - x109 + x110 * x12 - x110 * x23 - x111 - x112 - x113 - x114 * x12 + x114 * x23 - x115 -
                     x116 - x117 - x118 + x119 * x32 - x119 * x40 - x120 - x121 * x32 + x121 * x40 - x122 - x123 -
                     x124 + x125 + x126 + x127 + x128 + x129 + x130 + x131 + x132 + x133 + x134 + x135 + x136 + x138 +
                     x16 * x88 - x16 * x93 - x19 * x80 + x19 * x90 + x25 * x83 - x25 * x89 - x31 * x82 + x31 * x86 -
                     x4 * x88 + x4 * x93 - x44 * x83 + x44 * x89 + x47 * x82 - x47 * x86 + x77 + x8 * x80 - x8 * x90);
            }
            ...
            UTOPIA_FUNCTION static void gradient(
                ...
                T x66 =
                    x40 * (-x1 * x10 * x23 + x10 * x18 * x20 - x19 * x36 - x20 * x21 * x5 + x23 * x5 * x6 + x24 * x36);
                gx[0] = -x41 - x43 - x44;
            ...
            UTOPIA_FUNCTION static void value(const T x, const T y, const T z, const T t, Result *UTOPIA_RESTRICT f) {
                using namespace utopia::device;
                // Automatically generated
                // FLOATING POINT OPS!
            ...
            UTOPIA_FUNCTION static void eval(
                ...
                T x67 =
                    x41 * (-x10 * x11 * x33 + x10 * x19 * x4 + x14 * x31 - x19 * x6 * x7 + x3 * x33 * x6 - x31 * x5);
                f[0] = -t - x - y - z + 1;
                f[1] = x;
                f[2] = y;
                f[3] = z;
