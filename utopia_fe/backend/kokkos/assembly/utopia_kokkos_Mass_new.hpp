...
namespace utopia {
    ...
    namespace kokkos {
        ...
        public:
            ...
            MassNew(Params op = Params()) : Super(), op_(std::move(op)) {}
            ...
            bool hessian_assemble(AssemblyMode mode) override {
                ...
                assembler->assemble_matrix_eij("MassNew::hessian", mode, op_.uniform_kernel(assembler->fe()));
            ...
            bool apply_assemble(utopia::kokkos::Field<FE> &field, AssemblyMode mode) override {
                ...
                assembler->assemble_apply_ei("MassNew::apply", mode, op_.uniform_kernel(assembler->fe()), field);
