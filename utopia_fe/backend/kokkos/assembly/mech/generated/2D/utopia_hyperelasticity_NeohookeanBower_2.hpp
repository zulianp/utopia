...
T x30 = lambda*x5 + x13*(-x0*x15 - x1*x15 - x29 + x5*x8) + x28;
T x31 = grad_test[0]*(-f[1]*x14 + x13*(-f[1]*x20 + x24 - x25));
T x32 = lambda*x6 + x13*(x15*x2 + x15*x3 + x29 + x6*x8) - x28;
T x33 = -f[1]*x23 + x13*(-f[1]*x26 - x17 + x19);
bf[0] += dx*(grad_trial[0]*(grad_test[0]*(lambda*x0 + x13*(x0*x8 + x12)) + grad_test[1]*x21) + grad_trial[1]*(grad_test[0]*x21 + grad_test[1]*(lambda*x3 + x13*(x22 + x3*x8))));
...
bf[3] += dx*(grad_trial[0]*(grad_test[0]*(lambda*x2 + x13*(x2*x8 + x22)) + grad_test[1]*x33) + grad_trial[1]*(grad_test[0]*x33 + grad_test[1]*(lambda*x1 + x13*(x1*x8 + x12))));
			}
...
lf[1] += dx*(grad_test[0]*(-f[1]*x1 + x4*(f[1]*x3 + f[2]*x2)) + grad_test[1]*(f[0]*x1 + x4*(-f[0]*x3 + f[3]*x2)));
				...
				) const
			{
			    ...
			    // Automatically generated
				T x0 = f[0]*f[3] - f[1]*f[2];
e += dx*((1.0/2.0)*lambda*pow(x0 - 1, 2) + (1.0/2.0)*mu*(-2 + (pow(f[0], 2) + pow(f[1], 2) + pow(f[2], 2) + pow(f[3], 2))/pow(x0, 2.0/3.0)));
			}
...
T x32 = lambda*x0 + x10*(x0*x15 - x14 - x19*x5 - x19*x8) + x11;
T x33 = grad_test[0]*(-f[1]*x18 + x10*(-f[1]*x24 + x28 - x29));
T x34 = lambda*x1 + x10*(x1*x15 + x14 + x19*x6 + x19*x7) - x11;
T x35 = -f[1]*x27 + x10*(-f[1]*x30 - x21 + x23);
e += dx*((1.0/2.0)*lambda*pow(x3, 2) + x10*(x4*x9 - 2));
...
bf[0] += dx*(grad_trial[0]*(grad_test[0]*(lambda*x8 + x10*(x15*x8 + x17)) + grad_test[1]*x25) + grad_trial[1]*(grad_test[0]*x25 + grad_test[1]*(lambda*x7 + x10*(x15*x7 + x26))));
...
bf[3] += dx*(grad_trial[0]*(grad_test[0]*(lambda*x6 + x10*(x15*x6 + x26)) + grad_test[1]*x35) + grad_trial[1]*(grad_test[0]*x35 + grad_test[1]*(lambda*x5 + x10*(x15*x5 + x17))));
			}
...
T lambda;
		...
		template<typename T>
		void read_parameters(Input &in, NeohookeanBower<T, 2> &obj)
		{
			in.get("mu", obj.mu);
