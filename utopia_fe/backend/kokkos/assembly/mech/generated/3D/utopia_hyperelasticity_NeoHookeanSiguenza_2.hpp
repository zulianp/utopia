...
T x45 = x14*x3;
T x46 = x13*x3;
bf[0] += dx*(grad_test[0]*(grad_trial[0]*(x21*(x16*x19 + x26) - x23*x6 + x23) + grad_trial[1]*x22) + grad_test[1]*(grad_trial[0]*x22 + grad_trial[1]*(x21*(x15*x19 + x28) - x27*x6 + x27)));
bf[1] += dx*(grad_test[0]*(grad_trial[1]*x36 + x32) + grad_test[1]*(grad_trial[0]*x42 + x40));
bf[2] += dx*(grad_test[0]*(grad_trial[1]*x42 + x32) + grad_test[1]*(grad_trial[0]*x36 + x40));
bf[3] += dx*(grad_test[0]*(grad_trial[0]*(x21*(x14*x19 + x28) - x45*x6 + x45) + grad_trial[1]*x44) + grad_test[1]*(grad_trial[0]*x44 + grad_trial[1]*(x21*(x13*x19 + x26) - x46*x6 + x46)));
			}
...
lf[1] += dx*(grad_test[0]*(-f[1]*x1 + x5*(f[1]*x4 + f[2]*x3)) + grad_test[1]*(f[0]*x1 + x5*(-f[0]*x4 + 2*f[3]*x2)));
				...
				) const
			{
			    ...
			    // Automatically generated
				T x0 = f[0]*f[3] - f[1]*f[2];
e += dx*((1.0/2.0)*G*(pow(x0, -0.66666666666666663)*(pow(f[0], 2) + pow(f[1], 2) + pow(f[2], 2) + pow(f[3], 2)) - 2) + (1.0/2.0)*K*pow(log(x0), 2));
			}
...
lf[1] += dx*(grad_test[0]*(-f[1]*x11 + x10*(f[1]*x14 + f[2]*x12)) + grad_test[1]*(f[0]*x11 + x10*(-f[0]*x14 + 2*f[3]*x4)));
bf[0] += dx*(grad_test[0]*(grad_trial[0]*(x10*(x24*x8 + x29) - x27*x3 + x27) + grad_trial[1]*x26) + grad_test[1]*(grad_trial[0]*x26 + grad_trial[1]*(x10*(x24*x7 + x31) - x3*x30 + x30)));
bf[1] += dx*(grad_test[0]*(grad_trial[1]*x37 + x35) + grad_test[1]*(grad_trial[0]*x43 + x41));
bf[2] += dx*(grad_test[0]*(grad_trial[1]*x43 + x35) + grad_test[1]*(grad_trial[0]*x37 + x41));
bf[3] += dx*(grad_test[0]*(grad_trial[0]*(x10*(x24*x6 + x31) - x3*x46 + x46) + grad_trial[1]*x45) + grad_test[1]*(grad_trial[0]*x45 + grad_trial[1]*(x10*(x24*x5 + x29) - x3*x47 + x47)));
			}
...
T x45 = x13*x3;
T x46 = x14*x3;
res[0] += dx*(grad_test[0]*(disp_grad[0]*(x21*(x16*x19 + x30) - x27*x6 + x27) + disp_grad[1]*x22 + disp_grad[2]*x26 + disp_grad[3]*x34) + grad_test[1]*(disp_grad[0]*x22 + disp_grad[1]*(x21*(x15*x19 + x40) - x39*x6 + x39) + disp_grad[2]*x42 + disp_grad[3]*x38));
res[1] += dx*(grad_test[0]*(disp_grad[0]*x26 + disp_grad[1]*x42 + disp_grad[2]*(x21*(x14*x19 + x40) - x46*x6 + x46) + disp_grad[3]*x44) + grad_test[1]*(disp_grad[0]*x34 + disp_grad[1]*x38 + disp_grad[2]*x44 + disp_grad[3]*(x21*(x13*x19 + x30) - x45*x6 + x45)));
			}
