...
namespace utopia {
	namespace kernels {
		...
		public:
			...
			UTOPIA_FUNCTION static void hessian(const T C1,
				const T C2,
			...
			UTOPIA_FUNCTION static void gradient(const T C1,
				const T C2,
				const T *UTOPIA_RESTRICT f,
				const T *grad_test,
				const T dx,
			...
			UTOPIA_FUNCTION static void value(const T C1,
				const T C2,
				const T *UTOPIA_RESTRICT f,
				const T dx,
				T &e
			...
			UTOPIA_FUNCTION void eval(const T C1,
				const T C2,
				const T *UTOPIA_RESTRICT f,
				const T *grad_test,
				const T *grad_trial,
