...
e += dx*((1.0/2.0)*lambda*pow(x0, 2) - mu*x0 + (1.0/2.0)*mu*(pow(f[0], 2) + pow(f[1], 2) + pow(f[2], 2) + pow(f[3], 2) + pow(f[4], 2) + pow(f[5], 2) + pow(f[6], 2) + pow(f[7], 2) + pow(f[8], 2) - 3));
			}
...
T x135 = x131*x42;
T x136 = x132*x42;
e += dx*((1.0/2.0)*lambda*pow(x7, 2) - mu*x7 + (1.0/2.0)*mu*(pow(f[0], 2) + pow(f[1], 2) + pow(f[2], 2) + pow(f[3], 2) + pow(f[4], 2) + pow(f[5], 2) + pow(f[6], 2) + pow(f[7], 2) + pow(f[8], 2) - 3));
...
T lambda;
		...
		template<typename T>
		void read_parameters(Input &in, NeohookeanOgden<T, 3> &obj)
		{
			in.get("mu", obj.mu);
