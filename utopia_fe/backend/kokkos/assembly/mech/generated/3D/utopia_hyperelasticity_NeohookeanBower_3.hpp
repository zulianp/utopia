	...
	namespace kernels {
		...
		public:
				...
				)
			{
				...
				e += dx*((1.0/2.0)*lmbda*pow(x0 - 1, 2) + (1.0/2.0)*mu*(-3 + (pow(f[0], 2) + pow(f[1], 2) + pow(f[2], 2) + pow(f[3], 2) + pow(f[4], 2) + pow(f[5], 2) + pow(f[6], 2) + pow(f[7], 2) + pow(f[8], 2))/pow(x0, 2.0/3.0)));
			}
