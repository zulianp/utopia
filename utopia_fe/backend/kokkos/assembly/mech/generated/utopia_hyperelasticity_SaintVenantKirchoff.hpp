...
namespace utopia {
    namespace kernels {
        ...
        public:
            static_assert(Dim < 0,
                          "Automatically generated class -- SaintVenantKirchoff -- needs template specialization");
        };
    }  // namespace kernels

    namespace kokkos {
        template <class FunctionSpace, class FE, int Dim>
        using SaintVenantKirchoff = utopia::kokkos::
            AutoHyperElasticity<FunctionSpace, FE, utopia::kernels::SaintVenantKirchoff<typename FE::Scalar, Dim>>;
    }
}  // namespace utopia
