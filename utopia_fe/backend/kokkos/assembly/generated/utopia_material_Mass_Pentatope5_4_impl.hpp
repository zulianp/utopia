...
T x23 = x17*x6;
T x24 = x10*x19;
T x25 = weight*((-pt[0] + pt[1])*(x1*x14 + x10*x13 - x10*x16 - x15*x6 + x2*x5 + x6*x9) + (-px[0] + px[1])*(-x13*x21 + x14*x17 + x15*x19 + x16*x21 - x17*x5 - x19*x9) + (-py[0] + py[1])*(x1*x21*x4 + x12*x22 - x12*x24 + x18*x4 + x20*x7 - x23*x7) + (-pz[0] + pz[1])*(-x11*x18 + x11*x2*x21 - x20*x3 - x22*x8 + x23*x3 + x24*x8));
T x26 = x0*x25;
T x27 = x*x26;
T x28 = x26*y;
T x29 = x26*z;
...
T x23 = x17*x6;
T x24 = x10*x19;
T x25 = weight*((-pt[0] + pt[1])*(x1*x14 + x10*x13 - x10*x16 - x15*x6 + x2*x5 + x6*x9) + (-px[0] + px[1])*(-x13*x21 + x14*x17 + x15*x19 + x16*x21 - x17*x5 - x19*x9) + (-py[0] + py[1])*(x1*x21*x4 + x12*x22 - x12*x24 + x18*x4 + x20*x7 - x23*x7) + (-pz[0] + pz[1])*(-x11*x18 + x11*x2*x21 - x20*x3 - x22*x8 + x23*x3 + x24*x8))*(t*u[4] + u[0]*x0 + u[1]*x + u[2]*y + u[3]*z);
Hx[0] += x0*x25;
Hx[1] += x*x25;
Hx[2] += x25*y;
Hx[3] += x25*z;
...
g[4] += t*x25*x40;
	...
	namespace kokkos {
		template<class FE>
		using MassPentatope5 = utopia::kokkos::AutoKernel<FE, utopia::kernels::Mass<utopia::kernels::Pentatope5<typename FE::Scalar, typename FE::Scalar>>, 4>;
	}
}
