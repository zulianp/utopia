#ifndef UTOPIA_TPL_MATERIAL_Mass_2_IMPL_hpp
#define UTOPIA_TPL_MATERIAL_Mass_2_IMPL_hpp
    ...
    namespace kernels {
        ...
        public:
            ...
            UTOPIA_FUNCTION void hessian(
                ...
                T x0 = 1 - x;
                T x1 = 1 - y;
                T x2 = weight * (-px[0] * py[1] * y + px[0] * py[1] - px[0] * py[2] * x + px[0] * py[2] * y +
            ...
            UTOPIA_FUNCTION void apply(
                ...
                T x3 = 1 - x2;
                T x4 = x * x0;
                T x5 = weight * (u[0] * x1 + u[1] * x4 + u[2] * x2 + u[3] * x3) *
                       (-px[0] * py[1] * y + px[0] * py[1] - px[0] * py[2] * x + px[0] * py[2] * y + px[0] * py[3] * x -
                        px[0] * py[3] * y + px[1] * py[0] * y - px[1] * py[0] + px[1] * py[2] * x - px[1] * py[3] * x +
                        px[2] * py[0] * x - px[2] * py[0] * y - px[2] * py[1] * x - px[3] * py[0] * x +
                        px[3] * py[0] * y + px[3] * py[1] * x);
                Hx[0] += x1 * x5;
                Hx[1] += x4 * x5;
                Hx[2] += x2 * x5;
                Hx[3] += x3 * x5;
...
#endif  // UTOPIA_TPL_MATERIAL_Mass_2_IMPL_hpp
