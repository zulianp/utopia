...
//                 UTOPIA_INLINE_FUNCTION Scalar operator()(const int cell, const int qp, const int r, const int c)
//                 const {
...
//                     // Kokkos forces us to have the input values being declared volatile. Hence we need to make
//                     copies
