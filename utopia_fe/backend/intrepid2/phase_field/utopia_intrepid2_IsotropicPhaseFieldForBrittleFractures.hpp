...
//             class ScalarOp {
//             public:
//                 UTOPIA_INLINE_FUNCTION ScalarOp(const Energy<DegradationFunction> &energy, const DynRankView
//                 &measure)
...
//             //     UTOPIA_INLINE_FUNCTION void operator()(const int cell, const int i, const int j, const int qp)
//             const
//             //     {
//             //         V grad_i, grad_j;
