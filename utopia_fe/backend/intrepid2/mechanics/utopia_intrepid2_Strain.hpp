...
//                                              this->rank2_range(),
//                                              InterpolateAndStoreLinearized<1>(this->fe()->grad(), coeff,
//                                              this->data()));
//                         break;
//                     }
...
//                         Kokkos::parallel_for(this->name() + "::init_linearized",
//                                              this->rank2_range(),
//                                              InterpolateAndStoreLinearized<2>(this->fe()->grad(), coeff,
//                                              this->data()));
//                         break;
//                     }
...
//                         Kokkos::parallel_for(this->name() + "::init_linearized",
//                                              this->rank2_range(),
//                                              InterpolateAndStoreLinearized<3>(this->fe()->grad(), coeff,
//                                              this->data()));
//                         break;
//                     }
