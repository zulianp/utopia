...
namespace utopia {
    namespace intrepid2 {
        ...
        // using FEAssembler =
        //     utopia::kokkos::FEAssembler<intrepid2::FE<Scalar>, typename intrepid2::FE<Scalar>::DynRankView>;

        // template <typename Scalar>
        // class FEAssembler
        //     : public utopia::kokkos::FEAssembler<intrepid2::FE<Scalar>, typename intrepid2::FE<Scalar>::DynRankView>
        //     {
        // public:
        //     using FE = utopia::intrepid2::FE<Scalar>;
        //     using Super = utopia::kokkos::FEAssembler<FE, typename FE::DynRankView>;
        //     using Super::Super;
        ...
        //     void apply_operator(const std::string &name, const DynRankView &x, DynRankView &y, CellTestTrialOp
        //     op) {
        ...
        //     void apply_diagonal_operator(const std::string &name, const DynRankView &x, DynRankView &y,
        //     CellTestOp op) {
        ...
        //         void init_scalar(const FE &fe, int n_vars) { data_ = DynRankView("scalars", fe.n_cells(),
        //         n_vars); }
