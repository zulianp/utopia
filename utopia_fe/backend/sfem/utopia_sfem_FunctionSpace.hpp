#ifndef UTOPIA_SFEM_FUNCTIONSPACE_HPP
#define UTOPIA_SFEM_FUNCTIONSPACE_HPP
...
namespace utopia {
    template <>
    class Traits<utopia::sfem::FunctionSpace> : public Traits<utopia::sfem::Mesh> {
    public:
        using Mesh = utopia::sfem::Mesh;
        using Environment = utopia::Environment<utopia::sfem::FunctionSpace>;
    };

    namespace sfem {

        class FunctionSpace : public FunctionSpaceBase<sfem::Mesh>, public Traits<FunctionSpace> {
        public:
            ...
            // void node_eval(const std::string &part_name, std::function<void(const SizeType idx, const Scalar *)>
            // fun);
...
#endif  // UTOPIA_SFEM_FUNCTIONSPACE_HPP