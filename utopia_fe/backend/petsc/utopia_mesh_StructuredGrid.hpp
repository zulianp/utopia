...
#define UTOPIA_CONSTEXPR_VOID void
        ...
        UTOPIA_INLINE_FUNCTION constexpr auto prod(const Array &vals, const SizeType &n) ->
            typename std::remove_reference<decltype(vals[0])>::type {
            if (n == 1) {
                return vals[0];
            } else {
        ...
        public:
            ...
            UTOPIA_INLINE_FUNCTION constexpr const Point &box_min() const { return box_min_; }

            UTOPIA_INLINE_FUNCTION constexpr const Point &box_max() const { return box_max_; }
            ...
            UTOPIA_INLINE_FUNCTION constexpr const IntArray &ghost_corners_begin() const {
                return ghost_corners_begin_;
            }
            ...
            UTOPIA_INLINE_FUNCTION constexpr Range dof_range() const { return Range(dof_range_begin_, dof_range_end_); }

            ////////////////////////////////////////////////////////////////
            //////////////////////// SETTERS //////////////////////////////
            ////////////////////////////////////////////////////////////////

            UTOPIA_INLINE_FUNCTION Point &box_min() { return box_min_; }

            UTOPIA_INLINE_FUNCTION Point &box_max() { return box_max_; }
            ...
            UTOPIA_INLINE_FUNCTION constexpr SizeType n_nodes() const { return prod(dims_, dims_.size()); }
            ...
            UTOPIA_INLINE_FUNCTION constexpr SizeType n_local_dofs() const { return dof_range_end_ - dof_range_begin_; }

            UTOPIA_INLINE_FUNCTION constexpr Scalar measure() const { return prod(box_max_ - box_min_); }
            ...
            UTOPIA_INLINE_FUNCTION void reinit(const IntArray &dims,
                                               const IntArray &corners_begin,
                                               const IntArray &corners_extent,
                                               const IntArray &ghost_corners_begin,
                                               const IntArray &ghost_corners_extent,
            ...
            template <class Array>
            UTOPIA_INLINE_FUNCTION UTOPIA_CONSTEXPR_VOID
            node_to_grid_coord(const SizeType &idx,
                               Array &tensor_index) const  //_local_no_ghost
            {
                const SizeType n = dim();
