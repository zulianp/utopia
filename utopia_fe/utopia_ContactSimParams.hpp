...
namespace utopia {
	...
	static const ContactSimParams contact8	  			  = { "../data/contact8.e", 1, 2, -1, 0.1, -0.2, 0.2, LARGE_VAL,false };
	...
	static const ContactSimParams contact_cylinder	  	  = { "../data/contact_cylinder.e", 1, 2, -1, 0.1, -0.2, 0.2, LARGE_VAL,false };
	...
	static const ContactSimParams triple_contact_circle	  = { "../data/triple_contact_circle.e", 1, 2, -1, 0.1, -0.2, 0.2, LARGE_VAL,false };
	static const ContactSimParams contact2	  			  = { "../data/contact2.e", 1, 2, -1, 0.1, -0.2, 0.2, LARGE_VAL,false };
	static const ContactSimParams contact_quads	  		  = { "../data/contact_quads.e", 1, 2, -1, 0.1, -0.2, 0.2, LARGE_VAL,false };
	static const ContactSimParams multi_contact	  		  = { "../data/multi_contact.e", 1, 2, -1, 0.1, -0.2, 0.2, LARGE_VAL,false };
