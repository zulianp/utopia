...
namespace utopia {
    ...
    inline static void project_points(const HouseholderTransformation &trafo,
    ...
    inline static void unproject_points(const HouseholderTransformation &trafo,
                                        const Point3 &translation,
    ...
    bool project_and_intersect(const Polygon3 &poly1,
    ...
    bool project_intersect_and_map_quadrature(const Polygon3 &poly1,
        ...
        map_quadrature_rule(
            q_points, q_weights, weight, result_2d, triangulations, composite_q_points_2d, composite_q_weights);
    ...
    void map_quadrature_rule(const std::vector<Polygon2::Vector> &q_points,
                             const std::vector<Polygon2::Scalar> &q_weights,
                             const Polygon3::Scalar weight,
