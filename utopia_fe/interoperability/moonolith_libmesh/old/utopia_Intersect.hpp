...
namespace utopia {
    ...
    public:
        ...
        inline Scalar signed_dist(const Vector &q) const { return dot(n, q - p); }
    ...
    public:
        ...
        inline Scalar signed_dist(const Vector &q) const { return dot(n, q) - d; }
    };
    ...
    public:
        ...
        const Vector &point(const SizeType i) const { return points[i]; }
        ...
        inline void resize(const std::size_t new_size) { points.resize(new_size); }
    ...
    inline int intersect(const Line3 &line,
                         const HalfSpace3 &half_space,
                         Line3 &result,
                         const Line3::Scalar tol = 1e-10) {
        using Vector = Line3::Vector;
        using Scalar = Line3::Scalar;
    ...
    inline int intersect(const Polygon3 &polygon,
                         const HPolyhedron3 &h_poly,
                         Polygon3 &result,
                         const Polygon3::Scalar tol = 1e-10) {
    ...
    inline void make(const HPolyhedron3::Vector &p0,
