...
namespace utopia {
    ...
    public:
        ...
        VElementAdapter(libMesh::MeshBase &fe,
            ...
            for (libMesh::dof_id_type i = 0; i < e->n_nodes(); ++i) {
                const libMesh::Point &p = *utopia::libmesh::node_ptr(fe, e->node_id(i));
        ...
        VElementAdapter() : fe_(nullptr), element_(-1), element_handle_(-1), tag_(-1), dof_map_(nullptr) {}
        ...
        void set_dof_map_reverse(std::vector<long> *ptr) { dof_map_reverse_ = ptr; }
