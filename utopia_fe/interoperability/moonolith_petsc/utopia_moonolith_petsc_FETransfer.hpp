#ifndef UTOPIA_MOONOLITH_PETSC_FE_TRANSFER_HPP
#define UTOPIA_MOONOLITH_PETSC_FE_TRANSFER_HPP
...
namespace utopia {
    ...
    template <>
    class FETransfer<utopia::petsc::FunctionSpace> : public utopia::petsc::FETransfer {};

}  // namespace utopia

#endif  // UTOPIA_MOONOLITH_PETSC_FE_TRANSFER_HPP