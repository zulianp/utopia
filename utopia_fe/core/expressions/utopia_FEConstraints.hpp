...
namespace utopia {
    ...
    public:
        ...
        FEConstraints(const Constraint &... eqs) : eqs_(eqs...) {}

        FEConstraints(const std::tuple<Constraint...> &eqs) : eqs_(eqs) {}
        ...
        const std::tuple<Constraint...> &equations() const { return eqs_; }
