...
namespace utopia {
    ...
    public:
        ...
        Interpolate(Coeff &&coeff, Fun &fun) : coeff_(std::forward<Coeff>(coeff)), fun_(fun) {}

        inline Fun &fun() { return fun_; }

        inline const Fun &fun() const { return fun_; }

        inline Coefficient &coefficient() { return coeff_; }

        inline const Coefficient &coefficient() const { return coeff_; }
    ...
    inline Interpolate<ConstantCoefficient<T, Order>, Fun> interpolate(const ConstantCoefficient<T, Order> &coeff,
                                                                       Fun &fun,
                                                                       Tensor &&tensor) {
