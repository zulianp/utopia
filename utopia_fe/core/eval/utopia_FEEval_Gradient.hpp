...
namespace utopia {
    ...
    public:
        ...
        inline static auto apply(const Gradient<Function<Space> > &expr, AssemblyContext<Backend> &ctx) -> GradientT {
        ...
        inline static auto apply(const Gradient<Function<ProductFunctionSpace<Spaces> > > &expr,
