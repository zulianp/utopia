...
namespace utopia {
	...
	public:
	    ...
	    inline static auto apply(
	    	...
	    	FEBackend<Backend>::multiply(FEEval<Left, Traits, Backend, IsQuadData>::apply(expr.left(), ctx), expr.right(), ctx)
	    	    	)
	    {
	    	return FEBackend<Backend>::multiply(FEEval<Left, Traits, Backend, IsQuadData>::apply(expr.left(), ctx), expr.right(), ctx);
	    } 
	};
