...
namespace utopia {
    ...
    public:
        ...
        inline static const Expr &apply(const Expr &expr, const AssemblyContext<Backend> &) { return expr; }
    ...
    public:
        ...
        inline static int order(const ConstantCoefficient<T, Order> &expr, const AssemblyContext &) { return 0; }
    };
}  // namespace utopia
