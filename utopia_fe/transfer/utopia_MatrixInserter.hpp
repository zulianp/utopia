...
namespace utopia {
    ...
    public:
        MatrixInserter(MPI_Comm mpi_comm, const bool use_add = true)
            : comm(mpi_comm), m_matrix(comm), redist(comm), use_add(use_add) {}
        ...
        template <typename IDX>
        void set_non_zero(const std::vector<IDX> &rows, std::vector<double> &vec) {
            std::size_t n_rows = rows.size();
        ...
        template <typename IDX>
        void add(const std::vector<IDX> &rows, std::vector<double> &vec) {
            std::size_t n_rows = rows.size();
        ...
        template <typename IDX>
        void set_non_zero(const moonolith::Storage<IDX> &rows, moonolith::Storage<double> &vec) {
            std::size_t n_rows = rows.size();
        ...
        template <typename IDX>
        void add(const moonolith::Storage<IDX> &rows, moonolith::Storage<double> &vec) {
            std::size_t n_rows = rows.size();
