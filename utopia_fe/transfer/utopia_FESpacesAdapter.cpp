...
namespace utopia {
   ...
   const unsigned int &_to_var_num)
 {
   ...
   Copy_Dof_Map::copy_global_dofs(*master, dof_map_master, _from_var_num, dof_maps_[0],  var_type_[0], n_elements);
   Copy_Dof_Map::copy_global_dofs(*slave, dof_map_slave,  _to_var_num,  dof_maps_[1], var_type_[1], n_elements);
