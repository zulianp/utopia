...
namespace utopia {
        ...
        const unsigned int &to_var_num)
    {
        ...
        Copy_Dof_Map::copy_global_dofs(*master, dof_map_master, from_var_num, dof_maps_[0],  var_type_[0], handle_to_element_id_[0]);
        Copy_Dof_Map::copy_global_dofs(*slave, dof_map_slave,  to_var_num,  dof_maps_[1], var_type_[1], handle_to_element_id_[1]);
