...
namespace utopia {
    ...
    bool InterpolationLocalAssembler::assemble(const Elem &trial,
                                               FEType trial_type,
                                               const Elem &test,
                                               FEType test_type,
                                               Matrix &mat) {
    ...
    void InterpolationLocalAssembler::contained_points(const Elem &trial,
                                                       const Elem &test,
                                                       std::vector<int> &test_dofs) {
        int n_potential_nodes = test.n_nodes();
    ...
    void InterpolationLocalAssembler::contained_points_1(const Elem &trial,
                                                         const Elem &test,
                                                         std::vector<int> &test_dofs) {
    ...
    void InterpolationLocalAssembler::contained_points_2(const Elem &trial,
                                                         const Elem &test,
                                                         std::vector<int> &test_dofs) {
    ...
    void InterpolationLocalAssembler::contained_points_3(const Elem &trial,
                                                         const Elem &test,
                                                         std::vector<int> &test_dofs) const {
        Polyhedron poly;
