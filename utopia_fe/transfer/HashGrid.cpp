...
namespace utopia {
    ...
    void HashGrid::hash_range(const libMesh::DenseVector<libMesh::Real> &min,
    ...
    HashGrid::HashGrid(const Box &box, const std::vector<int> &dims) : box_(box), dims_(dims), n_cells_(1) {
        box_.enlarge(1e-8);
