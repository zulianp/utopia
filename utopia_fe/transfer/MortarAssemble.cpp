...
namespace utopia {
    ...
    void AffineTransform2::compute_affine_transformation(const libMesh::Elem * elem, libMesh::DenseMatrix<libMesh::Real> &A_inv, libMesh::DenseVector<libMesh::Real> &A_inv_m_b){
        ...
        libMesh::Point p_corr_0, p_corr_1, p_corr_2;
        ...
        switch(elem->type())
        {
            ...
            case libMesh::QUAD8:
            {
                ...
                
                {
                    ...
                    libMesh::Point p_ref_0(0.0, 0.0, 0.0);
                    
                    libMesh::Point p_ref_1(1.0, 0.0, 0.0);
                    
                    libMesh::Point p_ref_2(0.0, 1.0, 0.0);
                    
                    
                    p_corr_0 = libMesh::FE<2, libMesh::LAGRANGE>::map(elem, p_ref_0);
                    
                    p_corr_1 = libMesh::FE<2, libMesh::LAGRANGE>::map(elem, p_ref_1);
                    
                    p_corr_2 = libMesh::FE<2, libMesh::LAGRANGE>::map(elem, p_ref_2);
                    
                    
                    
                    A(0,0) =  (p_corr_1(0)-p_corr_0(0));
                    A(0,1) =  (p_corr_2(0)-p_corr_0(0));
                    A(1,0) =  (p_corr_1(1)-p_corr_0(1));
                    A(1,1) =  (p_corr_2(1)-p_corr_0(1));
                    ...
                    A_inv_m_b(0) = -1.0 * A_inv(0,0) * p_corr_0(0) - A_inv(0,1) * p_corr_0(1);
                    A_inv_m_b(1) = -1.0 * A_inv(1,0) * p_corr_0(0) - A_inv(1,1) * p_corr_0(1);
    ...
    void AffineTransform3::compute_affine_transformation(const libMesh::Elem * elem, libMesh::DenseMatrix<libMesh::Real> &A_inv, libMesh::DenseVector<libMesh::Real> &A_inv_m_b){
        ...
        libMesh::Point p_corr_0, p_corr_1, p_corr_2, p_corr_3;
        ...
        libMesh::Point p_ref_3(0.0, 0.0, 1.0);
        ...
        p_corr_0 = libMesh::FE<3, libMesh::LAGRANGE>::map(elem, p_ref_0);
        
        p_corr_1 = libMesh::FE<3, libMesh::LAGRANGE>::map(elem, p_ref_1);
        
        p_corr_2 = libMesh::FE<3, libMesh::LAGRANGE>::map(elem, p_ref_2);
        
        p_corr_3 = libMesh::FE<3, libMesh::LAGRANGE>::map(elem, p_ref_3);
        
        
        
        A(0,0) =  p_corr_1(0) - p_corr_0(0);
        A(0,1) =  p_corr_2(0) - p_corr_0(0);
        A(0,2) =  p_corr_3(0) - p_corr_0(0);
        A(1,0) =  p_corr_1(1) - p_corr_0(1);
        A(1,1) =  p_corr_2(1) - p_corr_0(1);
        A(1,2) =  p_corr_3(1) - p_corr_0(1);
        A(2,0) =  p_corr_1(2) - p_corr_0(2);
        A(2,1) =  p_corr_2(2) - p_corr_0(2);
        A(2,2) =  p_corr_3(2) - p_corr_0(2);
        ...
        A_inv_m_b(0) = -1.0 * A_inv(0,0) * p_corr_0(0) - A_inv(0,1) * p_corr_0(1) - 1.0 * A_inv(0,2) * p_corr_0(2);
        A_inv_m_b(1) = -1.0 * A_inv(1,0) * p_corr_0(0) - A_inv(1,1) * p_corr_0(1) - 1.0 * A_inv(1,2) * p_corr_0(2);
        A_inv_m_b(2) = -1.0 * A_inv(2,0) * p_corr_0(0) - A_inv(2,1) * p_corr_0(1) - 1.0 * A_inv(2,2) * p_corr_0(2);
...
//        
//        std::cout<<"ref_0==>"<< ref(0) <<std::endl;
//        std::cout<<"ref_1==>"<< ref(1) <<std::endl;
//        std::cout<<"ref_2==>"<< ref(2) <<std::endl;
