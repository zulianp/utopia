...
namespace utopia {
    ...
    public:
        ...
        Contact() : initialized_(false), has_contact_(false) {}
        ...
        inline const USparseMatrix &orthogonal_trafo() const override { return orthogonal_trafo_; }
        ...
        inline void remove_mass(const UVector &in, UVector &out) const override { out = e_mul(inv_mass_vector_, in); }
