...
namespace utopia {
    ...
    public:
        ...
        using ContactStressT =
            utopia::ContactStress<ProductFunctionSpace<LibMeshFunctionSpace>, USparseMatrix, UVector>;
        ...
        void read(Input &is) override {
            try {
                ...
                is.get("qp-solver", [this](Input &in) {
                    this->qp_solver = std::make_shared<OmniQPSolver<USparseMatrix, UVector>>();
        ...
        inline const UIContactParams &params() const { return params_; }

        std::shared_ptr<ElasticMaterial<USparseMatrix, UVector>> model() { return model_; }

        double dt() const { return dt_; }

        inline bool use_amg() const { return use_amg_; }
    ...
    static void solve_steady(ContactAppInput &sim_in, Input &in) {
        ...
        ContactSolverT sc(make_ref(sim_in.space()), sim_in.model(), params.contact_params);
    ...
    static void solve_transient(ContactAppInput &sim_in, Input &in) {
        ...
        ContactSolverT sc(make_ref(sim_in.space()), sim_in.model(), sim_in.dt(), params.contact_params);
