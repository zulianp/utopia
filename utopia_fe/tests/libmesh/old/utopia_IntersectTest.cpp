...
namespace utopia {
    void intersect_hex_with_polygon_test() {
        Polygon3 poly = {{{0.4, 0.5, 0.3}, {0.4, 0.5, 0.2}, {0.3, 0.5, 0.2}, {0.3, 0.5, 0.3}}};
        ...
        Polygon3 oracle = {{{0.33333333333333331, 0.5, 0.20000000000000001},
    ...
    void intersect_tet_with_polygon_test_1() {
        Polygon3 poly = {{{0.5, 0.3, 0.}, {0.5, 0.3, 0.1}, {0.5, 0.2, 0.1}, {0.5, 0.2, 0.}}};

        HPolyhedron3 h = {{{{0.70710678118654746, 0.70710678118654746, 0}, 0.70710678118654746},
                           {{-0.70710678118654746, 0.70710678118654746, 0}, 0.},
                           {{0, -0.70710678118654746, 0.70710678118654746}, 0.},
                           {{0, 0, 1.}, 0.}}};
    ...
    void intersect_tet_with_polygon_test_3() {
        Polygon3 poly = {{// { 0.5, 0.099999999999999978, 0.099999999999999978 },
