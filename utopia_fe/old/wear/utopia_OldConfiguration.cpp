...
namespace utopia {
    ...
    double OldConfiguration::dt() const { return dt_; }
    ...
    void OldConfiguration::displacement_and_forces(ProductFunctionSpace<LibMeshFunctionSpace> &space,
    ...
    void OldConfiguration::Rotation::init(const int n_dims, const int n_steps) {
    ...
    void OldConfiguration::Rotation::update(const int step, const double t) {
    ...
    void OldConfiguration::Translation::init(const int n_dims, const int n_steps) {
    ...
    void OldConfiguration::Translation::update(const int step, const double t) {
        if (from_step == -1 || to_step == -1) {
