...
set(LIBMESH_SEARCH_PATHS "/usr/local/;/usr/")

if(UTOPIA_ENABLE_ENV_READ)
  set(LIBMESH_SEARCH_PATHS
      "${LIBMESH_SEARCH_PATHS};$ENV{LIBMESH_DIR};$ENV{Libmesh_DIR}")
endif()
...
set(LIBMESH_SEARCH_PATHS
    "${LIBMESH_SEARCH_PATHS};${LIBMESH_DIR}/include;$ENV{LIBMESH_DIR}/include;${PC_LIBMESH_INCLUDEDIR};${PC_LIBMESH_INCLUDE_DIRS};${LIBMESH_INCLUDES_MY_LOCATIONS}"
)

if(UTOPIA_INSTALL_LIBMESH)
  set(LIBMESH_SEARCH_PATHS "${LIBMESH_INSTALL_DIR}")
  message(STATUS "LIBMESH_INSTALL_DIR;${LIBMESH_INSTALL_DIR}")
endif()

find_path(
  LIBMESH_INCLUDE_DIR libmesh/libmesh.h
  HINTS ${LIBMESH_SEARCH_PATHS}
...
# message( STATUS "HERE: $ENV{LIBMESH_DIR}/lib ${LIBMESH_LIBRARY} -> method:
# ${METHOD}!")
