...
set(LIBMESH_SEARCH_PATHS "${LIBMESH_SEARCH_PATHS};${LIBMESH_DIR}/include;$ENV{LIBMESH_DIR}/include;${PC_LIBMESH_INCLUDEDIR} ${PC_LIBMESH_INCLUDE_DIRS};${LIBMESH_INCLUDES_MY_LOCATIONS}")
...
# message(
#   STATUS "HERE: $ENV{LIBMESH_DIR}/lib ${LIBMESH_LIBRARY} -> method: ${METHOD}!")
