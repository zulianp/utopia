...
namespace utopia {
    ...
    public:
        ...
        ConstantCoefficient(const T &value) : value_(value) {}

        inline const T &expr() const { return value_; }

        inline operator const T &() const { return value_; }

        inline std::string get_class() const override { return "ConstantCoefficient" + std::to_string(Order); }

        // always returns value_
        inline const T &operator[](const int) const { return value_; }
    ...
    public:
        ...
        inline std::string get_class() const override { return "ConstantCoefficient0"; }
    ...
    public:
        ...
        FunctionCoefficient(const Fun &fun) : fun_(fun) {}
        ...
        inline std::string get_class() const override { return "FunctionCoefficient" + std::to_string(Order); }

        inline const Fun &fun() const { return fun_; }

        inline Fun &fun() { return fun_; }
    ...
    public:
        ...
        inline std::string get_class() const override { return "FunctionCoefficient0"; }
    ...
    inline FunctionCoefficient<std::function<std::array<T, N>(const std::array<T, N> &)>, T, 1> coeff(
        std::function<std::array<T, N>(const std::array<T, N> &)> fun) {
        return fun;
    }
    ...
    template <class Point, class T>
    inline FunctionCoefficient<std::function<void(const Point &, T &)>, T, 1> vec_coeff(
        std::function<void(const Point &, T &)> fun) {
        return fun;
    }
