...
namespace utopia {
    ...
    public:
        ...
        enum { Order = utopia::Traits<Tensor>::Order };

        BlockVar(const Tensor &default_value, const std::vector<std::pair<int, Tensor> > &init_list)
        ...
        inline std::string get_class() const override { return "BlockVar"; }
    ...
    template <class Tensor>
    inline BlockVar<Tensor> block_var(const Tensor &default_value,
