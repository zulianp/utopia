...
namespace utopia {
    ...
    public:
        ...
        UIMesh(const std::shared_ptr<libMesh::DistributedMesh> &mesh) : mesh_(mesh), empty_(false) {}
        ...
        void read(Input &is) override {
            ...
            // build_extrusion (UnstructuredMesh &mesh, const MeshBase &cross_section, const unsigned int nz,
        ...
        inline std::shared_ptr<libMesh::DistributedMesh> mesh_ptr() { return mesh_; }
    ...
    private:
        ...
        libMesh::ElemType get_type(const std::string &elem_type,
                                   const int order,
                                   const int dim,
