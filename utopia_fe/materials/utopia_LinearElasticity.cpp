...
namespace utopia {
    ...
    template<class FunctionSpaceT, class Matrix, class Vector>
    bool LinearElasticity<FunctionSpaceT, Matrix, Vector>::normal_stress(const UVector &x, UVector &out, const int subspace)
    {
        auto u  = trial(V_);
    ...
    template<class FunctionSpaceT, class Matrix, class Vector>
    bool LinearElasticity<FunctionSpaceT, Matrix, Vector>::von_mises_stress(const UVector &x, UVector &out, const int subspace)
    {
        auto u = trial(V_);
        auto vx = test(V_[subspace]);
