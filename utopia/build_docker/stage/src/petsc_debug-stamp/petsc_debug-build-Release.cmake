...
set(stdout_log "/shared/utopia/build_docker/stage/src/petsc_debug-stamp/petsc_debug-build-out.log")
set(stderr_log "/shared/utopia/build_docker/stage/src/petsc_debug-stamp/petsc_debug-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /shared/utopia/build_docker/stage/src/petsc_debug-stamp/petsc_debug-build-*.log")
  endif()
  ...
  set(msg "petsc_debug build command succeeded.  See also /shared/utopia/build_docker/stage/src/petsc_debug-stamp/petsc_debug-build-*.log")
  message(STATUS "${msg}")
endif()
