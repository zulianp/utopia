...
set(stdout_log "/shared/utopia/build_docker/stage/src/petsc-stamp/petsc-build-out.log")
set(stderr_log "/shared/utopia/build_docker/stage/src/petsc-stamp/petsc-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /shared/utopia/build_docker/stage/src/petsc-stamp/petsc-build-*.log")
  endif()
  ...
  set(msg "petsc build command succeeded.  See also /shared/utopia/build_docker/stage/src/petsc-stamp/petsc-build-*.log")
  message(STATUS "${msg}")
endif()
