...
namespace utopia {
    ...
    template <class FunctionSpace>
    static void enforce_BC_time_dependent(FunctionSpace &space,
                                          const typename FunctionSpace::Scalar &disp,
                                          const typename FunctionSpace::Scalar &t) {
    ...
    template <class FunctionSpace>
    static void build_irreversility_constraint(const PetscVector &x_old,
                                               PetscVector &x_new,
    ...
    static void petsc_phase_field_2(Input &in) {
        ...
        phase_field_fracture_sim(space, stats, in);
    }
