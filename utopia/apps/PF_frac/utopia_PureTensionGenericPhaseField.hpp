...
namespace utopia {
    ...
    public:
        ...
        using GenericPhaseFieldFormulation = utopia::GenericPhaseFieldFormulation<FunctionSpace, Dim, PFFormulation, VolDevEnergySplit>;
                    ...
                    this->space_.element_range(), UTOPIA_LAMBDA(const SizeType &i) {
                        ...
                        for (SizeType qp = 0; qp < NQuadPoints; ++qp) {
                            ...
                            for (SizeType j = 0; j < C_NDofs; ++j) {
                                ...
                                const Scalar frac = GenericPhaseFieldFormulation::
