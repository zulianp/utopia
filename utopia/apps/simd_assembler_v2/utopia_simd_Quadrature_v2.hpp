...
namespace utopia {
    ...
    namespace simd_v2 {
        ...
        public:
            ...
            template <int Dim>
            static void vectorize(utopia::Quadrature<T, Dim> &q_scalar, utopia::simd_v2::Quadrature<T, Dim> &q) {
            ...
            public:
                static bool get(const int order, simd_v2::Quadrature<T, 2> &q) {
                    utopia::Quadrature<T, 2> q_scalar;

                    if (!utopia::Gauss<T>::Tri::get(order, q_scalar)) {
                        return false;
                    }
            ...
            public:
                static bool get(const int order, simd_v2::Quadrature<T, 2> &q) {
                    ...
                    if (!utopia::Gauss<T>::Quad::get(order, q_scalar)) {
                        return false;
                    }
            ...
            public:
                static bool get(const int order, simd_v2::Quadrature<T, 3> &q) {
                    utopia::Quadrature<T, 3> q_scalar;

                    if (!utopia::Gauss<T>::Hex::get(order, q_scalar)) {
                        return false;
                    }
