...
namespace utopia {
    ...
    namespace simd_v2 {
        ...
        public:
            ...
            template <int Dim>
            static void vectorize(simd_v2::Quadrature<T, Dim> &q_scalar, simd_v2::Quadrature<VectorType, Dim> &q) {
            ...
            class Tri {
            public:
                static bool get(const int order, simd_v2::Quadrature<VectorType, 2> &q) {
            ...
            class Hex {
            public:
                static bool get(const int order, simd_v2::Quadrature<VectorType, 3> &q) {
