...
namespace utopia {
    ...
    public:
        ...
        static const T &get(const Matrix &t, const std::size_t &i, const std::size_t &j) { return t[i][j]; }

        static void set(Matrix &t, const std::size_t &i, const std::size_t &j, const T &val) { t[i][j] = val; }
    };
    ...
    public:
        ...
        inline static constexpr int n_points() { return NPoints; }

        inline static constexpr int dim() { return Dim; }
        ...
        inline const Scalar &weight(const int qp_idx) const { return weights_[qp_idx]; }
        ...
        QuadratureBase(const QuadratureBase &other) { copy(other); }
    ...
    //     inline const ViewDevice &view_device() const { return *this; }

    //     inline const ViewHost &view_host() const { return *this; }
    // };

    template <>
    class Quadrature<PetscUniformQuad4, 2, 2> : public QuadratureBase<2, 16, 2> {
    public:
        using Super = utopia::QuadratureBase<2, 16, 2>;
        using Scalar = Super::Scalar;
        using Point = Super::Point;
        using ViewDevice = Quadrature;
        using ViewHost = Quadrature;
    ...
    template <>
    class Quadrature<PetscUniformQuad4, 0, 2> : public QuadratureBase<0, 16, 2> {
    public:
        using Super = utopia::QuadratureBase<0, 16, 2>;
        using Scalar = Super::Scalar;
        using Point = Super::Point;
        using ViewDevice = Quadrature;
        using ViewHost = Quadrature;
        ...
        void init() { Quad4Quadrature<Scalar, 2, Super::Dim, Super::NPoints>::get(this->points_, this->weights_); }
    ...
    //         this->weights_ = {0.25, 0.25, 0.25, 0.25};
    //     }
    ...
    public:
        ...
        void init() {
            ...
            this->weights_ = {0.16666666666666666666666666666667,
    ...
    public:
        ...
        void init() { utopia::Quadrature<Scalar, 6, 1>::get(points_, weights_); }
    ...
    public:
        ...
        Quadrature(const Quadrature &other) : Super(other) {}
