...
namespace utopia {
    ...
    template <typename Scalar_>
    class Quad4Quadrature<Scalar_, 2, 2, 16> {
    public:
        static const int Order = 2;
        static const int Dim = 2;
        ...
        UTOPIA_INLINE_FUNCTION static void get(Points &points, Weights &weights) {
            ...
            PA::set(points, 0, 0, 0.5);
            PA::set(points, 0, 1, 0.5);
            PA::set(points, 1, 0, 0.87881458883025272376243091093078);
            PA::set(points, 1, 1, 0.5);
            PA::set(points, 2, 0, 0.38156407887214905330677888913682);
            PA::set(points, 2, 1, 0.5);
            PA::set(points, 3, 0, 0.005141035477736659342552582428439);
            PA::set(points, 3, 1, 0.5);
            PA::set(points, 4, 0, 0.97526047782283344179383397817322);
            PA::set(points, 4, 1, 0.18045434754981517329838236798414);
            PA::set(points, 5, 0, 0.97526047782283344179383397817322);
            PA::set(points, 5, 1, 0.81954565245018482670161763201586);
            PA::set(points, 6, 0, 0.83194136844281658918106215312182);
            PA::set(points, 6, 1, 0.031465461537504778123884459552616);
            PA::set(points, 7, 0, 0.83194136844281658918106215312182);
            PA::set(points, 7, 1, 0.96853453846249522187611554044738);
            PA::set(points, 8, 0, 0.65210534086205225452112163378099);
            PA::set(points, 8, 1, 0.23145823472925316105117594700364);
            PA::set(points, 9, 0, 0.65210534086205225452112163378099);
            PA::set(points, 9, 1, 0.76854176527074683894882405299636);
            PA::set(points, 10, 0, 0.3817516407319402596713732685346);
            PA::set(points, 10, 1, 0.056405746775187680490155875505254);
            PA::set(points, 11, 0, 0.3817516407319402596713732685346);
            PA::set(points, 11, 1, 0.94359425322481231950984412449475);
            PA::set(points, 12, 0, 0.15052326195671822003768421503399);
            PA::set(points, 12, 1, 0.25265058966490183398785216925757);
            PA::set(points, 13, 0, 0.15052326195671822003768421503399);
            PA::set(points, 13, 1, 0.74734941033509816601214783074243);
            PA::set(points, 14, 0, 0.049804612894210133218263327939714);
            PA::set(points, 14, 1, 0.051252090860116231232972080068356);
            PA::set(points, 15, 0, 0.049804612894210133218263327939714);
            PA::set(points, 15, 1, 0.94874790913988376876702791993164);

            WA::set(weights, 0, 0.013841176405359943061584002713742);
            WA::set(weights, 1, 0.10109734218151885333357243373724);
            WA::set(weights, 2, 0.13338665123815861383831921172309);
            WA::set(weights, 3, 0.029263547196684801606179593070438);
            WA::set(weights, 4, 0.031403604403436701032964263059526);
            WA::set(weights, 5, 0.031403604403436701032964263059526);
            WA::set(weights, 6, 0.034136146183397116833286999035414);
            WA::set(weights, 7, 0.034136146183397116833286999035414);
            WA::set(weights, 8, 0.12085211980281423777756638059528);
            WA::set(weights, 9, 0.12085211980281423777756638059528);
            WA::set(weights, 10, 0.063132126607385923345085246169134);
            WA::set(weights, 11, 0.063132126607385923345085246169134);
            WA::set(weights, 12, 0.090315580970543142281516900544439);
            WA::set(weights, 13, 0.090315580970543142281516900544439);
            WA::set(weights, 14, 0.021366063521561772809752589973953);
            WA::set(weights, 15, 0.021366063521561772809752589973953);
        }
    };
