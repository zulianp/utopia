...
namespace utopia {
    ...
    public:
        ...
        inline static BoundaryIdType from_name(const std::string &str_in) {
            ...
            std::transform(str_in.begin(), str_in.end(), str.begin(), [](unsigned char c) { return std::tolower(c); });
    ...
    public:
        ...
        static constexpr Sides ids_ = {SideSet::left(), SideSet::right()};
    ...
    public:
        ...
        static constexpr Sides ids_ = {SideSet::left(), SideSet::right(), SideSet::bottom(), SideSet::top()};
    ...
    public:
        ...
        static constexpr Sides ids_ =
            {SideSet::left(), SideSet::right(), SideSet::bottom(), SideSet::top(), SideSet::front(), SideSet::back()};
