...
namespace utopia {
    ...
    public:
        ...
        UTOPIA_INLINE_FUNCTION MassMatrixAssembler(const Elem &elem) : elem_(elem) {}
    ...
    public:
        ...
        void describe(std::ostream &os = std::cout) const { mat_.describe(os); }
    ...
    public:
        ...
        ScaledMassMatrix(const FunctionSpace &space, const Quadrature &q) : dx_(space, q), interpolate_(space, q) {}

        void update(const Vector &x) { interpolate_.update(x); }

        ViewDevice view_device() const { return ViewDevice(dx_.view_device(), interpolate_.view_device()); }
    ...
    private:
        ...
        UTOPIA_INLINE_FUNCTION static void assemble_aux(const Fun &fun,
                                                        const DX &dx,
