...
namespace utopia {
    ...
    public:
        ...
        UTOPIA_INLINE_FUNCTION Scalar measure() const { return h_; }

        template <typename PhysicalPoint>
        UTOPIA_INLINE_FUNCTION bool contains(const PhysicalPoint &p,
                                             const Scalar &tol = device::epsilon<Scalar>()) const {
        ...
        UTOPIA_INLINE_FUNCTION Edge2(const Point &p1, const Point &p2) { init(p1, p2); }
        ...
        void init() { h_ = norm2(nodes_[1] - nodes_[0]); }
