...
namespace utopia {
    ...
    public:
        ...
        UTOPIA_INLINE_FUNCTION auto partial_t(const int i, const Point &p) -> typename Traits<Point>::Scalar {
            return jacobian_inverse_(1, 0) * RefTri3::partial_x(i, p) +
                   jacobian_inverse_(1, 1) * RefTri3::partial_y(i, p);
        }
        ...
        UTOPIA_INLINE_FUNCTION void grad_x(const int i, const Point &p, Deriv &dst) {
            dst[0] =
                jacobian_inverse_(0, 0) * RefTri3::partial_x(i, p) + jacobian_inverse_(0, 1) * RefTri3::partial_y(i, p);
        }
        ...
        UTOPIA_INLINE_FUNCTION constexpr static Scalar reference_measure() { return 0.5; }

        UTOPIA_INLINE_FUNCTION Scalar measure() const { return measure_; }
        ...
        UTOPIA_INLINE_FUNCTION void set(const P0 &p0, const P1 &p1, const P2 &p2) {
            ...
            measure_ = det(jacobian_) * reference_measure();
        ...
        UTOPIA_INLINE_FUNCTION Point &translation() { return translation_; }
        UTOPIA_INLINE_FUNCTION Jacobian &jacobian() { return jacobian_; }
        UTOPIA_INLINE_FUNCTION JacobianInverse &jacobian_inverse() { return jacobian_inverse_; }
        UTOPIA_INLINE_FUNCTION Scalar &measure() { return measure_; }
