...
namespace utopia {
    ...
    public:
        ...
        UTOPIA_INLINE_FUNCTION const MeshView &mesh() const { return mesh_; }

        UTOPIA_INLINE_FUNCTION MeshView &mesh() { return mesh_; }
    ...
    public:
        ...
        ViewDevice view_device() { return ViewDevice(mesh_.view_device()); }

        Range element_range() const { return mesh_.element_range(); }
