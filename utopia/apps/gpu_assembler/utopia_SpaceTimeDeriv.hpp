...
namespace utopia {
    ...
    public:
        ...
        UTOPIA_INLINE_FUNCTION SpaceTimeDerivView(const STGradXValues &grad_x,
        ...
        UTOPIA_INLINE_FUNCTION std::size_t n_points() const { return NQPoints; }
    ...
    public:
        ...
        SpaceTimeDeriv(const FunctionSpace &space, const Quadrature &q) { init(space, q); }

        ViewDevice view_device() const { return ViewDevice(grad_x_, grad_x_partial_t_, partial_t_); }
