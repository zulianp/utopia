...
namespace utopia {
    ...
    public:
        ...
        UTOPIA_INLINE_FUNCTION static auto apply(const Scalar &diff_coeff,
                                                 const Grad &g_trial,
                                                 const Grad &g_test,
                                                 const DX &dx) -> decltype(dx * diff_coeff) {
    ...
    public:
        ...
        UTOPIA_INLINE_FUNCTION LaplacianAssembler(const Elem &elem, const Scalar diffusivity = 1.0)
