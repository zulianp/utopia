...
\begin{document}
% \maketitle
\href{https://github.com/zulianp/utopia}{\includegraphics[width=0.5\linewidth]{../../utopia_logo.pdf}}
\section{Installation}\footnotesize

\begin{lstlisting}[language=bash]
git clone --recurse-submodules  \
https://github.com/zulianp/utopia.git
...
Click  \href{https://github.com/zulianp/utopia/wiki/Getting-started}{HERE} for more details!
