...
if(UTOPIA_ENABLE_ENV_READ)
  set(METIS_SEARCH_PATHS_INCLUDE "${METIS_SEARCH_PATHS_INCLUDE};$ENV{METIS_DIR};$ENV{METISDIR}")
  set(METIS_SEARCH_PATHS_LIBRARY "${METIS_SEARCH_PATHS_LIBRARY};$ENV{METIS_DIR};$ENV{METISDIR}")
endif()
  # set(METIS_SEARCH_PATHS_INCLUDE "/usr/include/")
  # set(METIS_SEARCH_PATHS_LIBRARY "/usr/lib/;/usr/lib64/")

set(METIS_SEARCH_PATHS_INCLUDE "${METIS_SEARCH_PATHS_INCLUDE};${PETSC_DIR}/include")
set(METIS_SEARCH_PATHS_LIBRARY "${METIS_SEARCH_PATHS_LIBRARY};${PETSC_DIR}/lib")

find_path(METIS_INCLUDES 
  NAMES 
  metis.h 
  PATHS 
  ${METIS_SEARCH_PATHS_INCLUDE}
  PATH_SUFFIXES
  .
  metis
  include
...
find_library(METIS_LIBRARIES metis PATHS ${METIS_SEARCH_PATHS_LIBRARY} PATH_SUFFIXES lib)
