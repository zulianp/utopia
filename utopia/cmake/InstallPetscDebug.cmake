...
if(NOT PETSC_FOUND)
    ...
    ExternalProject_Add(
        ...
        LOG_CONFIGURE       1
        LOG_BUILD           1
        CONFIGURE_COMMAND <SOURCE_DIR>/configure --prefix=<INSTALL_DIR> --with-mpi=1 --download-superlu_dist=yes --download-superlu=yes --download-mumps=yes --download-scalapack=yes --download-hypre=yes --with-cxx-dialect=C++11 --with-debugging=1 #-with-mpi-include=${MPI_INCLUDE_PATH} --with-mpi-lib=${MPI_LIBRARIES}
