...
if(NOT UTOPIA_SPACK_MODE)

    find_library(
        MPI_CLANG_C_LIBRARY
        NAMES mpi mpi-mpich-clang
        PATHS ${MPI_DIR}/lib $ENV{MPI_DIR}/lib /opt/local/lib/openmpi-mp/
              /opt/local/lib/mpich-mp/ /opt/local/lib/mpich-clang/
              /opt/local/lib
        DOC "The MPI_CLANG_C_LIBRARY library to link against")

    find_library(
        MPI_CLANG_CXX_LIBRARY
        NAMES mpi_cxx mpicxx mpicxx-mpich-clang mpic++-mpich-clang
        PATHS ${MPI_DIR}/lib $ENV{MPI_DIR}/lib /opt/local/lib/openmpi-mp/
              /opt/local/lib/mpich-mp/ /opt/local/lib/mpich-clang/
              /opt/local/lib
    ...
    if(MPI_CLANG_CXX_LIBRARY)
        ...
        if(MPI_CLANG_HEADERS)
            find_file(
                MPI_CXX_COMPILER
                NAMES mpic++ mpicxx mpicxx-openmpi-mp mpicxx-mpich-clang
                      mpic++-mpich-clang mpic++-mpich-mp
                HINTS ${MPI_DIR}/bin
                      $ENV{MPI_DIR}/bin
            ...
            find_file(
                MPI_C_COMPILER
                NAMES mpicc-openmpi-mp mpicc-mpich-clang mpicc-mpich-mp mpicc
                HINTS ${MPI_DIR}/bin
                      $ENV{MPI_DIR}/bin
                      ${MPI_CLANG_HEADERS}/../bin
                      ${MPI_CLANG_HEADERS}/../../bin
    ...
    message(
        STATUS
            "MPI: ${MPI_CXX_LIBRARIES} ${MPI_CLANG_HEADERS} ${MPI_CXX_COMPILER}"
    )
endif()
