...
# This module exports:
#
# TRILINOS_DIR TRILINOS_INCLUDE_DIRS TRILINOS_LIBRARIES TRILINOS_VERSION
# TRILINOS_VERSION_MAJOR TRILINOS_VERSION_MINOR TRILINOS_VERSION_SUBMINOR
# TRILINOS_WITH_MANDATORY_CXX11 TRILINOS_WITH_MPI TRILINOS_SUPPORTS_CPP11
...
if(DEFINED Trilinos_VERSION)
    ...
    string(REGEX REPLACE "^([0-9]+).*$" "\\1" TRILINOS_VERSION_MAJOR
                         "${Trilinos_VERSION}")

    string(REGEX REPLACE "^[0-9]+\\.([0-9]+).*$" "\\1" TRILINOS_VERSION_MINOR
                         "${Trilinos_VERSION}")
...
find_package_handle_standard_args(
    Trilinos DEFAULT_MSG Trilinos_INCLUDE_DIRS Trilinos_LIBRARIES
    Trilinos_TPL_LIBRARIES) # Trilinos_TPL_INCLUDE_DIRS
                            # Trilinos_additional_headers)
