...
if(NOT PETSC_FOUND)
    ...
    ExternalProject_Add(
        ...
        LOG_CONFIGURE       1
        LOG_BUILD           1
        CONFIGURE_COMMAND <SOURCE_DIR>/configure --prefix=<INSTALL_DIR> --with-mpi=1 --download-mumps=yes --download-scalapack=yes --download-hypre=yes --with-cxx-dialect=C++11 --with-debugging=0  --with-64-bit-indices=1 ${PETSC_CONFIG_ARGS} #-with-mpi-include=${MPI_INCLUDE_PATH} --with-mpi-lib=${MPI_LIBRARIES} #--download-superlu_dist=yes --download-superlu=yes 
