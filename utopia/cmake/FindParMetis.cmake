...
if(${ParMetis_DIR})
  set(ParMetis_SEARCH_PATHS_INCLUDES
      "${ParMetis_INCLUDES};${ParMetis_INCLUDE_PATH};${ParMetis_ROOT}/include;${ParMetis_DIR}/include;/usr/local/include;/usr/include;/usr/include/metis"
  )

  set(ParMetis_SEARCH_PATHS_LIBRARY
      "${ParMetis_LIBRARY};${ParMetis_LIBRARY_PATH};${ParMetis_DIR};/usr/local;/usr"
  )
...
if(UTOPIA_ENABLE_ENV_READ)
  set(ParMetis_SEARCH_PATHS_INCLUDES
      "${ParMetis_SEARCH_PATHS_INCLUDES};$ENV{PARMETIS_INCLUDE_PATH};$ENV{PARMETIS_ROOT}/include;$ENV{PARMETIS_DIR}/include"
  )

  set(ParMetis_SEARCH_PATHS_LIBRARY
      "${ParMetis_SEARCH_PATHS_INCLUDES};$ENV{PARMETIS_LIBRARY_PATH};$ENV{PARMETIS_ROOT};$ENV{PARMETIS_DIR}"
  )
endif()
