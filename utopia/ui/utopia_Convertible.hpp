...
namespace utopia {
    ...
    public:
        ...
        NullConvertible *clone() const override { return new NullConvertible(); }
    };
    ...
    public:
        static void apply(const InOut &in, InOut &out) { out = in; }
    };

    template <typename In>
    class Convert<In, std::string> {
    public:
        static void apply(const In &in, std::string &out) { out = std::to_string(in); }
    };

    template <>
    class Convert<std::string, std::string> {
    public:
        static void apply(const std::string &in, std::string &out) { out = in; }
    };

    template <>
    class Convert<std::string, bool> {
    public:
        static void apply(const std::string &in, bool &out) { out = (in == "1" || in == "true" || in == "yes"); }
    };
    ...
    public:
        ...
        inline void get(float &in_out) const override { Convert<T, float>::apply(value_, in_out); }

        inline void get(int &in_out) const override { Convert<T, int>::apply(value_, in_out); }

        inline void get(long &in_out) const override { Convert<T, long>::apply(value_, in_out); }
        ...
        inline void get(unsigned long &in_out) const override { Convert<T, unsigned long>::apply(value_, in_out); }

        inline void get(long long int &in_out) const override { Convert<T, long long int>::apply(value_, in_out); }

        inline void get(bool &in_out) const override { Convert<T, bool>::apply(value_, in_out); }

        inline void get(std::string &in_out) const override { Convert<T, std::string>::apply(value_, in_out); }

        ////////////////////////////////////////

        inline void set(const double &in) { Convert<double, T>::apply(in, value_); }

        inline void set(const float &in) { Convert<float, T>::apply(in, value_); }

        inline void set(const int &in) { Convert<int, T>::apply(in, value_); }

        inline void set(const long &in) { Convert<long, T>::apply(in, value_); }
        ...
        inline void set(const unsigned long &in) { Convert<long, T>::apply(in, value_); }

        inline void set(const long long int &in) { Convert<long long int, T>::apply(in, value_); }

        inline void set(const bool &in) { Convert<bool, T>::apply(in, value_); }

        inline void set(const std::string &in) { Convert<std::string, T>::apply(in, value_); }
        ...
        inline Convertible *clone() const override { return new Convertible(value_); }
