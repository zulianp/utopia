...
#ifndef FENICS_UTOPIA_ASYNCH_GLOBAL_LOCAL_HPP
#define FENICS_UTOPIA_ASYNCH_GLOBAL_LOCAL_HPP
...
class FenicsUtopiaAsynchGLFunction : public utopia::GLFunction<GlobalMatrix, GlobalVector, LocalMatrix, LocalVector> 
{

    typedef utopia::FenicsDecomposition<GlobalMatrix, GlobalVector, LocalMatrix, LocalVector> FenicsDecomposition;

    public:
        FenicsUtopiaAsynchGLFunction(   std::shared_ptr<dolfin::Function>   u,
        ...
        bool hessian(const GlobalVector &x, GlobalMatrix &H) const override
        {
            ...
            // GlobalMatrix H_T = transpose(H); 
            // GlobalMatrix H_diff; 
            // H_diff = H_T - H; 
            // typename GlobalVector::Scalar f = norm2(H_diff);
            // std::cout<<"------- : "<< f<< "\n" ; 
...
// -----------------------------------------------------------------------------------------------------------------------
// --------------------------------------------- local evaluations  ------------------------------------------------------
//                                  subscript k stands for quantity on subset         
// -----------------------------------------------------------------------------------------------------------------------
        ...
        {   
            ...
            // dolfin::Scalar global_energy;
            // dolfin::assemble(global_energy, *_E);             
            // std::cout<<"globl energy: "<< global_energy.get_scalar_value()<< "   \n"; 
...
#endif  //FENICS_UTOPIA_ASYNCH_GLOBAL_LOCAL_HPP