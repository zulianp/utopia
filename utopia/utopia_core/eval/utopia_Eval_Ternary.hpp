...
namespace utopia {
    ...
    using TernaryExpr =
        utopia::Binary<utopia::Binary<Tensor<T1, Order>, Tensor<T2, Order>, Op1>, Tensor<T3, Order>, Op2>;
    ...
    private:
        ...
        inline static void apply_aux(AuxR &result,
                                     AuxT1 &&t1,
                                     AuxT2 &&t2,
                                     AuxT3 &&t3,
                                     const AuxOp1 &op1,
    ...
    using ScaledTernaryExpr = utopia::Binary<Binary<Tensor<V, 1>, Binary<Number<T>, Tensor<V, 1>, Multiplies>, Op1>,
                                             Binary<Number<T>, Tensor<V, 1>, Multiplies>,
                                             Op2>;
    ...
    class Eval<Binary<Tensor<V, 1>, Binary<Number<T>, Unary<Tensor<V, 1>, Op2>, Multiplies>, Minus>, Traits, Backend> {
    public:
        using Expr = Binary<Tensor<V, 1>, Binary<Number<T>, Unary<Tensor<V, 1>, Op2>, Multiplies>, Minus>;
    ...
    template <class V, class Op2, typename T, class Traits, int Backend>
    class Eval<
        Assign<Tensor<V, 1>, Binary<Tensor<V, 1>, Binary<Number<T>, Unary<Tensor<V, 1>, Op2>, Multiplies>, Minus>>,
        Traits,
        Backend> {
    public:
        using RightExpr = utopia::Binary<Tensor<V, 1>, Binary<Number<T>, Unary<Tensor<V, 1>, Op2>, Multiplies>, Minus>;
