...
namespace utopia {
    ...
    StandardLogger::StandardLogger(std::ostream &status_stream,
        ...
        : status_stream_(utopia::make_unique<StreamWrapper>(status_stream)),
          warning_stream_(utopia::make_unique<StreamWrapper>(warning_stream)),
          error_stream_(utopia::make_unique<StreamWrapper>(error_stream))
