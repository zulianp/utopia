...
namespace utopia {
    ...
    public:
        static constexpr UTOPIA_INLINE_FUNCTION SizeType select(const SizeType &i,
                                                                const SizeType &,
                                                                const SizeType &,
                                                                const SizeType &) {
            return i;
    ...
    public:
        static constexpr UTOPIA_INLINE_FUNCTION SizeType select(const SizeType &,
                                                                const SizeType &j,
                                                                const SizeType &,
                                                                const SizeType &) {
            return j;
    ...
    class DeviceTensorProduct<Left, Right, I, J, K, L>
        : public DeviceExpression<DeviceTensorProduct<Left, Right, I, J, K, L>> {
    public:
        ...
        UTOPIA_INLINE_FUNCTION DeviceTensorProduct(const Left &left, const Right &right) : left_(left), right_(right) {}

        UTOPIA_INLINE_FUNCTION Scalar operator()(const SizeType &i,
                                                 const SizeType &j,
                                                 const SizeType &k,
                                                 const SizeType &l) const {
            return left_(ISelector::select(i, j, k, l), JSelector::select(i, j, k, l)) *
                   right_(KSelector::select(i, j, k, l), LSelector::select(i, j, k, l));
        }
