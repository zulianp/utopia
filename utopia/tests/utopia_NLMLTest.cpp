    ...
    public:
        ...
        void initialize() override {
            ...
            this->register_experiment("RMTR_first_order_infty", [this]() {
                ...
                // auto rmtr = std::make_shared<RMTR_inf<Matrix, Vector, TRBoundsGratton<Matrix, Vector>,
                // FIRST_ORDER_MGOPT> >(n_levels_);
                auto rmtr =
                    std::make_shared<RMTR_inf<Matrix, Vector, TRGrattonBoxKornhuber<Matrix, Vector>, FIRST_ORDER> >(
                        n_levels_);
    ...
    public:
        ...
        void initialize() override {
            ...
            this->register_experiment("RMTR_quasi_LBFGS_test_inf_unconstrained", [this]() {
                ...
                auto rmtr =
                    std::make_shared<QuasiRMTR_inf<Matrix, Vector, TRBoundsGratton<Matrix, Vector> > >(n_levels_);
