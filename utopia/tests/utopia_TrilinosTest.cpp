...
namespace utopia {
    ...
    public:
        ...
        void trilinos_residual()
        {
            ...
            TpetraMatrixd Id; Id.identity(layout(comm_, n, n, Traits::determine(), Traits::determine()), 1.0);
        ...
        {
            auto n = 10;
            TpetraMatrixd Y; Y.sparse(layout(comm_, n, n, Traits::determine(), Traits::determine()), 3, 2);
            assemble_laplacian_1D(Y);
        ...
        {
            auto n = 10;
            TpetraMatrixd X; X.sparse(layout(comm_, n, n, Traits::determine(), Traits::determine()), 3, 2);
        ...
        void trilinos_mv()
        {
            ...
            TpetraMatrixd m; m.sparse(layout(comm_, n, n, Traits::determine(), Traits::determine()), 3, 2);
            assemble_laplacian_1D(m);
        ...
        void trilinos_apply_transpose()
        {
            auto rows = 5;
            auto cols = 6;
            TpetraMatrixd A; A.sparse(layout(comm_, rows, cols, Traits::determine(), Traits::determine()), 2, 2);
        ...
        void trilinos_transpose()
        {
            ...
            TpetraMatrixd id; id.identity(layout(comm_, rows, cols, Traits::determine(), Traits::determine()), 1.0);
        ...
        {
            auto n = 10;
            TpetraMatrixd A; A.sparse(layout(comm_, n, n, Traits::determine(), Traits::determine()), 3, 2);
        ...
        void trilinos_diag_rect_matrix()
        {
            auto n = 10;
            auto m = 3;
            TpetraMatrixd A; A.identity(layout(comm_, n, m, Traits::determine(), Traits::determine()), 1.0);
            TpetraVectord d;
            d  = diag(A);
            const double val = norm1(d);
        ...
        void test_ptap(const int n, const int m)
        {
            ...
            PetscMatrix A_petsc; A_petsc.sparse(layout(comm_, n, n, PetscTraits::determine(), PetscTraits::determine()), 3, 2);
        ...
        void st_cg_test()
        {
            ...
            Matrix A; A.sparse(layout(comm_, Traits::decide(), Traits::decide(), _n, _n), 3, 2);
        ...
        {
            TpetraMatrixd A; A.sparse(layout(comm_, 4, 4, Traits::determine(), Traits::determine()), 3, 2);
            assemble_laplacian_1D(A);
            ...
            TpetraMatrixd B; B.sparse(layout(A), 3, 2);
        ...
        {
            TpetraMatrixd A; A.sparse(layout(comm_, 2, 3, Traits::determine(), Traits::determine()), 4, 4);
        ...
        void trilinos_copy_write()
        {
            ...
            TpetraMatrixd A;
            MultiLevelTestProblem1D<TpetraMatrixd, TpetraVectord, Poisson1D<TpetraMatrixd,TpetraVectord > > ml_problem(10, 2);
        ...
        {
            TpetraMatrixd m; m.identity(layout(comm_, 10, 10, Traits::determine(), Traits::determine()), 1.0);
