#ifndef UTOPIA_GAUSSIAN_09_CONSTRAINED
#define UTOPIA_GAUSSIAN_09_CONSTRAINED
...
namespace utopia {
    ...
    class Gaussian09Constrained final : public ConstrainedTestFunction<Matrix, Vector> {
    public:
        using Scalar = typename utopia::Traits<Matrix>::Scalar;
        using SizeType = typename utopia::Traits<Vector>::SizeType;

        Gaussian09Constrained() {
        ...
        std::string name() const override { return "Gaussian, bound constrained"; }
...
#endif  // UTOPIA_GAUSSIAN_09_CONSTRAINED