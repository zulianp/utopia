            ...
            auto n = size(x).get(0);
            {
                ...
                for (SizeType i = r.begin(); i != r.end(); ++i) {
                    ...
                    if (i == 0) {
                        ...
                        Scalar term1 = 6.0 * std::pow(h_, 2) * element *
                                       (0.5 * h_ * h_ * std::pow(element, 3) + 2.0 * xi - xi_m - xi_p);
                        Scalar term2 = 2.0 * (1.5 * h_ * h_ * (element * element) + 2.0) *
                                       (1.5 * h_ * h_ * (element * element) + 2.0);
