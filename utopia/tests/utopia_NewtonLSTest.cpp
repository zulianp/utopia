...
namespace utopia 
{
	...
	public:
		...
		{
			return "NewtonLSBenchmark benchmark.";
		}
		...
		void initialize() override
		{
		 ...
		 //            run_newton(this->test_functions_,  solver, "NewtonTest_FACTORIZATION", this->verbose_);
			// 	}
			// );

			this->register_experiment("NewtonTest_CG_HOMEMADE_GS",
				[this]() {
			...
			this->register_experiment("NewtonTest_CG_BACKEND_GS",
				[this]() {
		 ...
		 //            Newton<Matrix, Vector> solver(lin_solver);
		 //            run_newton(this->test_functions_parallel_, solver, "NewtonTest_BiCGSTAB_HOMEMADE_Jacobi", this->verbose_);
		 //            run_newton(this->test_functions_, solver, "NewtonTest_BiCGSTAB_HOMEMADE_Jacobi", this->verbose_);
			// 	}
			// );
