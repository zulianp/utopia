...
namespace utopia {
    ...
    public:
        ...
        static constexpr std::size_t decide() { return static_cast<std::size_t>(INVALID_INDEX); }

        // tells tpetra to compute global size automatically
        static Tpetra::global_size_t determine() { return Teuchos::OrdinalTraits<Tpetra::global_size_t>::invalid(); }
    };
