...
template<>
struct std::less<std::pair<utopia::Size, utopia::Size>> {
...
namespace utopia {
	...
	public:
		...
		void put(Vec* v, Size& local, Size& global);
		void put(Mat* m, Size& local, Size& global);
		void putSparse(Mat* m, Size& local, Size& global);
#endif // WITH_PETSC
