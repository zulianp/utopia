...
namespace utopia {
	...
	private:
		...
		std::unordered_map<std::pair<Size, Size>, Vec*> vec_pool_;
		std::unordered_map<std::pair<Size, Size>, Mat*> mat_pool_;
		std::unordered_map<std::pair<Size, Size>, Mat*> sparse_mat_pool_;
#endif // WITH_PETSC
