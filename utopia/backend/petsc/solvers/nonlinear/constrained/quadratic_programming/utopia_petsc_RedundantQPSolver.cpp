...
namespace utopia {
    ...
    bool RedundantQPSolver<PetscMatrix, PetscVector>::valid() const { return static_cast<bool>(qp_solver_); }
    ...
    bool RedundantQPSolver<PetscMatrix, PetscVector>::solve(const Operator<PetscVector> &A,
