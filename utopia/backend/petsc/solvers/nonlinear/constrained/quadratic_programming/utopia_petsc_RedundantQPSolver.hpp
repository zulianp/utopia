...
namespace utopia {
    ...
    template<>
    class RedundantQPSolver<PetscMatrix, PetscVector, PETSC> final : public OperatorBasedQPSolver<PetscMatrix, PetscVector>
    {
    ...
    public:
        RedundantQPSolver(
            const std::shared_ptr<OperatorBasedQPSolver> &qp_solver,
            const int n_sub_comm = 2)
