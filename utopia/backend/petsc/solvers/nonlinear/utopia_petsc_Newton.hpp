...
namespace utopia {
    ...
    public:
        ...
        void line_search_order(const SizeType &order) { line_search_order_ = (order < 4 && order > 0) ? order : 3; }
        ...
        void print_usage(std::ostream &os) const override {
            ...
            this->print_param_usage(
                os, "line_search_order", "int", "Interpolation order used inside of linea-search-strategy.", "3");
