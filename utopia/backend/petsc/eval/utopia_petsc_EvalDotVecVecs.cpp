...
namespace utopia {
    ...
    template <class Vector>
    void EvalDots<Vector, PETSC>::apply(const Vector &v11,
                                        const Vector &v12,
                                        Scalar &result1,
                                        const Vector &v21,
                                        const Vector &v22,
    ...
    template <class Vector>
    void EvalNorm2s<Vector, PETSC>::apply(const Vector &v1, const Vector &v2, Scalar &result1, Scalar &result2) {
    ...
    template <class Vector>
    void EvalNorm2s<Vector, PETSC>::apply(const Vector &v1,
                                          const Vector &v2,
                                          const Vector &v3,
                                          Scalar &result1,
                                          Scalar &result2,
