...
namespace utopia {
    ...
    public:
        ...
        void print_current_collective_usage(std::ostream &os = std::cout) const;
...
#define UTOPIA_PETSC_COLLECTIVE_MEMUSAGE() {  PetscDebugger::instance().print_current_collective_usage(); }
