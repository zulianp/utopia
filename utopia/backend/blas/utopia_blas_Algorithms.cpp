...
namespace utopia {
    ...
    template <>
    void BLASAlgorithms<double>::gemm(const char transa,
                                      const char transb,
                                      const int m,
                                      const int n,
                                      const int k,
    ...
    template <>
    void BLASAlgorithms<double>::gemv(const char trans,
                                      const int m,
                                      const int n,
                                      const double alpha,
                                      const double *a,
                                      ...
                                      double *c,
                                      const int incy) {
        dgemv_(&trans, &m, &n, &alpha, a, &lda, x, &incx, &beta, c, &incy);
    }

    template <>
    void BLASAlgorithms<double>::axpy(const int n,
                                      const double alpha,
                                      const double *x,
                                      const int incx,
                                      double *y,
    ...
    template <>
    double BLASAlgorithms<double>::ddot(const int n,
                                        const double *sx,
                                        const int incx,
                                        const double *sy,
                                        const int incy) {
