...
namespace utopia {
    ...
    template <>
    int LapackAlgorithms<double>::sygvx(int itype,
                                        char jobz,
                                        char range,
                                        char uplo,
                                        int n,
    ...
    template <>
    void LapackAlgorithms<double>::pteqr(char compz,
                                         int n,
                                         double *D,
                                         double *E,
                                         double *Z,
    ...
    template <>
    void LapackAlgorithms<double>::sytrd(char uplo,
                                         int n,
                                         double *A,
                                         int lda,
                                         double *D,
    ...
    template <>
    void LapackAlgorithms<double>::orgtr(char uplo,
                                         int n,
                                         double *A,
                                         int lda,
                                         double *tau,
    ...
    template <>
    void LapackAlgorithms<double>::syev(char jobz,
                                        char uplo,
                                        int n,
                                        double *a,
                                        int lda,
