...
namespace utopia {
	...
	class Eval<
			...
			> {
	public:
		typedef utopia::Multiply< Binary<Number<Alpha>, A, Multiplies>, Wrapper<B, 2>> Expr;
	    typedef typename TypeAndFill<Traits, Multiply<A, Wrapper<B, 2>> >::Type C;
	...
	public:
	    ...
	    typedef typename TypeAndFill<Traits, Wrapper<C, 2>>::Type Result;
