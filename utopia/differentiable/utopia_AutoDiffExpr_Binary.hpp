...
namespace utopia {
    ...
    public:
        ...
        typedef utopia::Binary<Binary<DLeft, Right, EMultiplies>, Binary<Left, DRight, EMultiplies>, Plus> ComplexType;
        ...
        inline static UTOPIA_STORE_CONST(Type) make(const Left &left, const Right &right, const EMultiplies &) {
            return utopia::Simplify<ComplexType>::make(e_mul(DiffLeft::make(left), right) +
    ...
    public:
        ...
        inline static UTOPIA_STORE_CONST(Type) make(const Left &left, const Right &right, const Plus &) {
            return utopia::Simplify<ComplexType>::make(DiffLeft::make(left) + DiffRight::make(right));
        }
    };
    ...
    public:
        ...
        inline static UTOPIA_STORE_CONST(Type) make(const Left &left, const Right &right, const Multiplies &) {
            return utopia::Simplify<ComplexType>::make(left * DiffRight::make(right));
        }
    };
}  // namespace utopia
