...
namespace utopia {
    ...
    public:
        ...
        static UTOPIA_STORE_CONST(Type)
            make(const Factory<Identity, Order> &left, const Factory<Identity, Order> &, const Plus &) {
    ...
    public:
        ...
        static UTOPIA_STORE_CONST(Type)
            make(const Factory<Zeros, Order> &left, const Factory<Zeros, Order> &, const Plus &) {
            return left;
        }
    };
    ...
    public:
        ...
        static const UTOPIA_STORE_CONST(Type)
            make(const Expr &left, const Factory<Identity, Order> & /*right*/, const EMultiplies &) {
    ...
    public:
        ...
        static UTOPIA_STORE_CONST(Type)
            make(const Factory<Identity, Order> & /*left*/, const Expr &right, const EMultiplies &) {
    ...
    public:
        ...
        static UTOPIA_STORE_CONST(Type)
            make(const Factory<Zeros, Order> &left, const Expr & /*right*/, const EMultiplies &) {
            return left;
        }
    };
    ...
    public:
        ...
        static UTOPIA_STORE_CONST(Type)
            make(const Expr & /*left*/, const Factory<Zeros, Order> &right, const EMultiplies &) {
            return right;
        }
    };
    ...
    public:
        ...
        static const UTOPIA_STORE_CONST(Type)
            make(const Expr &left, const Factory<Identity, Order> & /*right*/, const Multiplies &) {
            return Simplify<Expr>::make(left);
        }
    };
    ...
    public:
        ...
        static UTOPIA_STORE_CONST(Type)
            make(const Factory<Identity, Order> & /*left*/, const Expr &right, const Multiplies &) {
            return Simplify<Expr>::make(right);
        }
    };
    ...
    public:
        ...
        static UTOPIA_STORE_CONST(Type)
            make(const Factory<Zeros, Order> &left, const Expr & /*right*/, const Multiplies &) {
            return left;
        }
    };
    ...
    public:
        ...
        static UTOPIA_STORE_CONST(Type)
            make(const Expr & /*left*/, const Factory<Zeros, Order> &right, const Multiplies &) {
            return right;
        }
    };
    ...
    public:
        ...
        static UTOPIA_STORE_CONST(Type) make(const Binary<Left, Right, Operation> &expr) {
            return Sim::make(Simplify<Left>::make(expr.left()), Simplify<Right>::make(expr.right()), expr.operation());
        }
    };
}  // namespace utopia
