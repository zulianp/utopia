    ...
    public:
        ...
        void initialize() override {
            ...
            for (SizeType i = 0; i < n_instances; ++i) {
                ...
                this->register_experiment("vec_transform_" + std::to_string(i), [vl]() {
                    Vector v(vl, -3.0);
                ...
                this->register_experiment("mat_transform_" + std::to_string(i), [ml]() {
                    Matrix A;
                    A.sparse(ml, 3, 2);
                ...
                this->register_experiment("mat_chop_" + std::to_string(i), [ml]() {
                    Matrix A;
                    A.sparse(ml, 3, 2);
                    assemble_laplacian_1D(A);
