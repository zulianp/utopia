    ...
    public:
        ...
        void initialize() override {
            ...
            for (SizeType i = 0; i < n_instances; ++i) {
                ...
                this->register_experiment("allocation_" + std::to_string(i), [vl, ml]() {
                    Vector x(vl, 1.);
                    Vector y(vl, 2.);
                    Matrix A;
                    A.sparse(ml, 3, 2);
                ...
                this->register_experiment("assembly_" + std::to_string(i), [vl, ml]() {
                    Matrix A;
                    A.sparse(ml, 3, 2);
                ...
                // matrix-vector mult
                this->register_experiment("mv_" + std::to_string(i), [vl, ml]() {
                    Vector x(vl, 1.);
                    Vector y(vl, 2.);
                    Matrix A;
                    A.sparse(ml, 3, 2);
