...
# SIMD= Single instruction multiple data. Type of parallel processing in Flynn's txonomy... Look on wikipedia.
# option(UTOPIA_ENABLE_VC "SIMD wrapper" OFF)
# Ask what m3elinsol is.
