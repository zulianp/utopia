...
namespace utopia {
    ...
    using DotOpDot = utopia::Binary<Dot<Tensor<X, 1>, Tensor<X, 1> >, Dot<FunOfX, Tensor<X, 1> >, Op>;
    ...
    public:
        ...
        inline static Scalar apply(const Expr &expr) {
            ...
            Scalar left, right;
            EvalDots<X, Backend>::apply(t1, t2, left, t3, t4, right);
    ...
    using AlphaDotOpBetaDot = utopia::Binary<Binary<Number<T>, Dot<Tensor<X, 1>, Tensor<X, 1> >, LeftOp>,
    ...
    public:
        ...
        inline static Scalar apply(const Expr &expr) {
            ...
            const Scalar ret = expr.operation().apply(left_op.apply(alpha, left), right_op.apply(beta, right));
