...
namespace utopia {
    ...
    public:
        inline static bool apply(const Assign<View<Left>, Right> &expr) {
            ...
            apply_aux(Eval<Left, Traits>::apply(expr.left().expr()), rr, cr, Eval<Right, Traits>::apply(expr.right()));
        ...
        inline static void apply_aux(Tensor<Derived, 1> &left,
        ...
        template <class Derived>
        inline static void apply_aux(Tensor<Derived, 2> &left,
                                     const Range &row_range,
    ...
    public:
        inline static bool apply(const Assign<Tensor<Left, Order>, View<Right>> &expr) {
            ...
            apply_aux(Eval<Tensor<Left, Order>, Traits>::apply(expr.left()),
