...
namespace utopia {
    ...
    public:
        ...
        UTOPIA_INLINE_FUNCTION static Scalar apply(const Scalar &left, const Scalar &right) { return left * right; }
    };
    ...
    public:
        ...
        UTOPIA_INLINE_FUNCTION static Scalar apply(const Left &left, const Right &right) {
            Scalar ret = 0.0;
