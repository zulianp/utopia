...
namespace utopia {
    ...
    class DeviceTensorContraction<Left, Right, 4, 2>
        : public DeviceExpression<DeviceTensorContraction<Left, Right, 4, 2>> {
    public:
    ...
    template <class Left, class Right>
    UTOPIA_INLINE_FUNCTION DeviceTensorContraction<Left, Right> contraction(const DeviceExpression<Left> &left,
