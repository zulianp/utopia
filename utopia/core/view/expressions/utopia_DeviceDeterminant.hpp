...
namespace utopia {
    ...
    public:
        ...
        UTOPIA_INLINE_FUNCTION static Scalar psuedo_det(
            const SizeType &rows,
            const SizeType &cols,
            const ExprT &t)
        {
            switch(rows)
            {
                ...
                case 4: 
                {
                    ...
                    return device::sqrt(det_4(
                        mult(0, 0), m01, m02, m03, 
                        m01, mult(1, 1), m12, m13,
                        m02, m12, mult(2, 2), m23,
                        m03, m13, m23, mult(3, 3)
                    ));
                }
