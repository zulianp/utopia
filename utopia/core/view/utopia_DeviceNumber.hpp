...
namespace utopia {
    ...
    public:
        ...
        UTOPIA_INLINE_FUNCTION operator Scalar &() { return value_; }

        UTOPIA_INLINE_FUNCTION constexpr operator const Scalar &() const { return value_; }
        ...
        UTOPIA_INLINE_FUNCTION bool is_alias(const DeviceNumber &other) const { return this == &other; }

        UTOPIA_INLINE_FUNCTION Scalar get() const { return value_; }

        UTOPIA_INLINE_FUNCTION void set(const Scalar &value) { value_ = value; }
        ...
        UTOPIA_INLINE_FUNCTION constexpr DeviceNumber(const DeviceNumber<OtherScalar> &other) : value_(other.value_) {}
        ...
        UTOPIA_INLINE_FUNCTION void construct(const DeviceNumber<Scalar> &expr) { value_ = expr.value_; }

        UTOPIA_INLINE_FUNCTION void assign(const DeviceNumber<Scalar> &expr) { value_ = expr.value_; }
