...
namespace utopia {
    ...
    public:
           ...
           const SizeType &l)
       {
        ...
        UTOPIA_INLINE_FUNCTION const Scalar &operator()(
            const SizeType &i,
            const SizeType &j,
            const SizeType &k,
        ...
        UTOPIA_INLINE_FUNCTION const Scalar &get(
            const SizeType &i,
            const SizeType &j,
            const SizeType &k,
            const SizeType &l) const
        ...
        UTOPIA_INLINE_FUNCTION void add(
            const SizeType &i,
            const SizeType &j,
            const SizeType &k,
            const SizeType &l,
        ...
        // template<class RightView, class ResultView>
        // UTOPIA_INLINE_FUNCTION void multiply(const TensorView<RightView, 4> &right, TensorView<ResultView, 4> &result) const
        // {
        //     // UTOPIA_DEVICE_ASSERT(!result.is_alias(right));
        ...
        UTOPIA_INLINE_FUNCTION void wrap(const ArrayView4D &view)
        {
            view_ = view;
        }
