...
#define UTOPIA_RECORD_SCOPE_BEGIN(macro_name_) { utopia::Recorder::instance().scope_begin(macro_name_); }
#define UTOPIA_RECORD_SCOPE_END(macro_name_) { utopia::Recorder::instance().scope_end(macro_name_); }
#else
