...
namespace utopia {
    ...
    constexpr int static_max(const int left, const int right) { return (left > right) ? left : right; }

    constexpr int static_min(const int left, const int right) { return (left < right) ? left : right; }
    ...
    public:
        enum {
            greatest_tensor_order =
                static_max(TreeProperties<Left>::greatest_tensor_order, TreeProperties<Right>::greatest_tensor_order)
        };
        enum {
            smallest_tensor_order =
                static_min(TreeProperties<Left>::smallest_tensor_order, TreeProperties<Right>::smallest_tensor_order)
        };
        enum { has_mat_mat_mul = TreeProperties<Left>::has_mat_mat_mul || TreeProperties<Right>::has_mat_mat_mul };
        enum {
            has_differentiable_sub_tree =
                TreeProperties<Left>::has_differentiable_sub_tree || TreeProperties<Right>::has_differentiable_sub_tree
        };
    };
    ...
    public:
        ...
        enum {
            has_mat_mat_mul = TreeProperties<Left>::has_mat_mat_mul || TreeProperties<Right>::has_mat_mat_mul ||
    ...
    // public:
    //     enum { greatest_tensor_order = static_max(TreeProperties<Left>::greatest_tensor_order,
    //     TreeProperties<Right>::greatest_tensor_order)  }; enum { smallest_tensor_order =
    //     static_min(TreeProperties<Left>::smallest_tensor_order, TreeProperties<Right>::smallest_tensor_order) }; enum
    //     { has_mat_mat_mul = TreeProperties<Right>::has_mat_mat_mul }; enum { has_differentiable_sub_tree =
    //     TreeProperties<Right>::has_differentiable_sub_tree  };
    // };
