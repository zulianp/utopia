...
namespace utopia {
    ...
    public:
        ...
        Reciprocal(const T &numerator) : numerator_(numerator) {}
    ...
    public:
        ...
        IsNonZero(const T tol = 0.) : tol_(tol) {}
    ...
    class PlusIsNonZero {
    public:
        PlusIsNonZero(const T tol = 0.) : is_non_zero_(tol) {}
        ...
        inline const IsNonZero<T> &is_non_zero() const { return is_non_zero_; }
