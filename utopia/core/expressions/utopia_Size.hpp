...
namespace utopia {
    ...
    public:
         ...
         *              To obtain size of the object, use following syntax: M.size().get(d), where M represents tensor
         * and d dimension of interest.
         *
         */
         ...
         *              Use following syntax: long d = M.size().n_dims(), where M represents tensor and d is its
         * dimension.
         *
         */
        inline SizeType n_dims() const { return _data.size(); }

        inline SizeType dims() const { return _data.size(); }
        ...
        const std::vector<SizeType> &data() const { return _data; }
        ...
        friend bool operator!=(const Size &l, const Size &r) { return !(l == r); }
    ...
    inline void disp(const Size &size, std::ostream &os) { disp(size.data().begin(), size.data().end(), os); }

    inline void disp(const Size &size) { return disp(size, std::cout); }
