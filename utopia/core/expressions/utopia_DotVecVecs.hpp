...
namespace utopia {
    ...
    public:
        static void apply(const Vector &v1,
                          ...
                          std::vector<typename utopia::Traits<Vector>::Scalar> &results) {
            ...
            for (auto i = 0; i < n; i++) results[i] = dot(v1, *(vectors[i]));
        }
        ...
        static void apply(const Vector &v11,
                          const Vector &v12,
                          typename utopia::Traits<Vector>::Scalar &result1,
                          const Vector &v21,
                          const Vector &v22,
                          typename utopia::Traits<Vector>::Scalar &result2) {
            result1 = dot(v11, v12);
            result2 = dot(v21, v22);
        }
        ...
        static void apply(const Vector &v11,
                          ...
                          const Vector &v31,
                          const Vector &v32,
                          typename utopia::Traits<Vector>::Scalar &result3) {
            result1 = dot(v11, v12);
            result2 = dot(v21, v22);
            result3 = dot(v31, v32);
        }
    ...
    class EvalNorm2s {
    public:
        static void apply(const Tensor<Vector, 1> &v1,
                          const Tensor<Vector, 1> &v2,
                          typename utopia::Traits<Vector>::Scalar &result1,
                          typename utopia::Traits<Vector>::Scalar &result2) {
            result1 = norm2(v1);
            result2 = norm2(v2);
    ...
    void dots(const Tensor<Vector, 1> &v1,
              const std::vector<std::shared_ptr<Vector> > &vectors,
              std::vector<typename utopia::Traits<Vector>::Scalar> &results) {
    ...
    template <class Vector>
    void dots(const Tensor<Vector, 1> &v11,
              const Tensor<Vector, 1> &v12,
              typename utopia::Traits<Vector>::Scalar &result1,
              const Tensor<Vector, 1> &v21,
              const Tensor<Vector, 1> &v22,
              typename utopia::Traits<Vector>::Scalar &result2) {
    ...
    void dots(const Tensor<Vector, 1> &v11,
              ...
              const Tensor<Vector, 1> &v22,
              typename utopia::Traits<Vector>::Scalar &result2,
              const Tensor<Vector, 1> &v31,
              const Tensor<Vector, 1> &v32,
              typename utopia::Traits<Vector>::Scalar &result3) {
        EvalDots<Vector>::apply(v11.derived(),
                                v12.derived(),
                                result1,
                                v21.derived(),
                                v22.derived(),
    ...
    template <class Vector>
    void norms2(const Tensor<Vector, 1> &v1,
                const Tensor<Vector, 1> &v2,
                typename utopia::Traits<Vector>::Scalar &result1,
                typename utopia::Traits<Vector>::Scalar &result2) {
