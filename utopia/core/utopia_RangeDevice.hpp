...
namespace utopia {
    ...
    public:
        ...
        UTOPIA_INLINE_FUNCTION SizeType begin() const { return begin_; }

        UTOPIA_INLINE_FUNCTION SizeType end() const { return end_; }

        UTOPIA_INLINE_FUNCTION SizeType extent() { return end() - begin(); }

        UTOPIA_INLINE_FUNCTION RangeDevice(const SizeType &begin, const SizeType &end) : begin_(begin), end_(end) {}
