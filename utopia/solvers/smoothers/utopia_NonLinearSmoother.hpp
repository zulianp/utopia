...
class NonLinearSmoother : virtual public Configurable {
 ...
 public:
  ...
  void print_usage(std::ostream &os) const override {
    this->print_param_usage(os, "relaxation_parameter", "double",
                            "Relaxation parameter.", "1");
    this->print_param_usage(os, "sweeps", "int", "Number of smoothing steps.",
                            "1");
  }

  virtual bool smooth(Function<Matrix, Vector> &fun, Vector &x,
                      const Vector &rhs) = 0;
   ...
   * @return
   */
  virtual SizeType sweeps() { return _sweeps; }
   ...
   */
  virtual Scalar relaxation_parameter() { return _relaxation_parameter; }
