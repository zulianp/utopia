...
template <class Matrix, class Vector, int Backend>
void ConjugateGradient<Matrix, Vector, Backend>::copy(
    const ConjugateGradient &other) {
...
template <class Matrix, class Vector, int Backend>
void ConjugateGradient<Matrix, Vector, Backend>::reset_initial_guess(
    const bool val) {
...
template <class Matrix, class Vector, int Backend>
void ConjugateGradient<Matrix, Vector, Backend>::print_usage(
    std::ostream &os) const {
  OperatorBasedLinearSolver<Matrix, Vector>::print_usage(os);
  this->print_param_usage(
      os, "reset_initial_guess", "bool",
      "Flag, which decides if initial guess should be reseted.", "false");
}

template <class Matrix, class Vector, int Backend>
bool ConjugateGradient<Matrix, Vector, Backend>::solve(
...
template <class Matrix, class Vector, int Backend>
void ConjugateGradient<Matrix, Vector, Backend>::update(
...
template <class Matrix, class Vector, int Backend>
ConjugateGradient<Matrix, Vector, Backend>
    *ConjugateGradient<Matrix, Vector, Backend>::clone() const {
...
template <class Matrix, class Vector, int Backend>
bool ConjugateGradient<Matrix, Vector, Backend>::unpreconditioned_solve(
    const Operator<Vector> &A, const Vector &b, Vector &x) {
  SizeType it = 0;
...
template <class Matrix, class Vector, int Backend>
bool ConjugateGradient<Matrix, Vector, Backend>::preconditioned_solve(
    const Operator<Vector> &A, const Vector &b, Vector &x) {
  SizeType it = 0;
...
template <class Matrix, class Vector, int Backend>
bool ConjugateGradient<Matrix, Vector, Backend>::check_solution(
    const Operator<Vector> &A, const Vector &x, const Vector &b) const {
  Vector r;
  A.apply(x, r);
  r -= b;
...
template <class Matrix, class Vector, int Backend>
void ConjugateGradient<Matrix, Vector, Backend>::init_memory(
    const Layout &layout) {
