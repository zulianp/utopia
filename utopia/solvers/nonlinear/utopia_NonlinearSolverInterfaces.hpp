 ...
 public:
  NonLinearGaussSeidel() {
    static_assert(Backend < HOMEMADE,
                  "NonLinearGaussSeidel not implemented for this backend");
  }
};
...
class NonLinearConjugateGradient {
 public:
  NonLinearConjugateGradient() {
    static_assert(
        Backend < HOMEMADE,
        "NonLinearConjugateGradient not implemented for this backend");
  }
};
...
class NonLinearGMRES {
 public:
  NonLinearGMRES() {
    static_assert(Backend < HOMEMADE,
                  "NonLinearGMRES not implemented for this backend");
  }
};
...
class NonLinearAnderson {
 public:
  NonLinearAnderson() {
    static_assert(Backend < HOMEMADE,
                  "NonLinearAnderson not implemented for this backend");
  }
};
