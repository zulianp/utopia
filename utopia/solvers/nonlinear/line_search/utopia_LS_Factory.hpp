...
class LSStrategyFactory {
 ...
 private:
  ...
  void init() {
    ...
    strategies_[Solver::backtracking()] =
        std::make_shared<LSFactoryMethodT<Backtracking<Vector>>>();
  }
};

template <class Vector>
typename LSStrategyFactory<Vector>::StrategyPtr line_search_strategy(
