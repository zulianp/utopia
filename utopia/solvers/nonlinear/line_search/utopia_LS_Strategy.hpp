...
public:
  ...
  LSStrategy()
      : c1_(1e-4), c2_(0.9), max_it_(50), rho_(0.5), alpha_min_(1e-7){
   ...
   * @return     The alpha.
   */
  virtual bool get_alpha(FunctionBase<Vector> &, const Vector &, const Vector &,
                         const Vector &, Scalar &) = 0;
  virtual bool get_alpha(LeastSquaresFunctionBase<Vector> &, const Vector &,
                         const Vector &, const Vector &, Scalar &) = 0;

  virtual void verbose(const bool &verbose) { verbose_ = verbose; }

  virtual bool verbose() const { return verbose_; }

  virtual void c1(const Scalar &c1_in) { c1_ = c1_in; }
  ...
  virtual void alpha_min(const Scalar &alpha_min) { alpha_min_ = alpha_min; }

  virtual Scalar alpha_min() const { return alpha_min_; }
  ...
  void print_usage(std::ostream &os) const override {
    ...
    this->print_param_usage(os, "c1", "double",
                            "Constant used for Wolfe conditions.", "1e-4");
    this->print_param_usage(os, "c2", "double",
                            "Constant used for Wolfe conditions.", "0.9");
    this->print_param_usage(os, "max_it", "int",
                            "Maximum number of iterations.", "50");
    this->print_param_usage(os, "rho", "double", "Contraction factor.", "0.75");
    this->print_param_usage(os, "alpha_min", "double",
                            "Minimum allowed step-size.", "1e-9");
  }
