// #ifndef UTOPIA_PRIMAL_INTERIOR_POINT_FUNCTION_HPP
// #define UTOPIA_PRIMAL_INTERIOR_POINT_FUNCTION_HPP
...
//     class PrimalInteriorPointFunction : public Function<Matrix, Vector> {
//     public:
...
//             if (!Options()
//                      .add_option(
//                          "barrier_parameter", barrier_parameter_, "see Numerical Optimization - J. Nocedal, S.
//                          Wright.")
...
//                      .add_option("min_barrier_parameter", min_barrier_parameter_, "Smallest barrier parameter
//                      allowed.") .add_option(
//                          "soft_boundary", soft_boundary_, "A value in (0,0.01) used to project in the feasible
//                          region.")
...
//         PrimalInteriorPointFunction(const std::shared_ptr<Function> &unconstrained,
...
//         void set_barrier_parameter_shrinking_factor(const Scalar value) { barrier_parameter_shrinking_factor_ =
//         value; }
...
// #endif  // UTOPIA_PRIMAL_INTERIOR_POINT_FUNCTION_HPP