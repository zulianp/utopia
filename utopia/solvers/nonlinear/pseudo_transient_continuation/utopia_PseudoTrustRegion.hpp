...
namespace utopia {
    ...
    public:
        PseudoTrustRegion(const std::shared_ptr<Solver> &linear_solver,
            ...
            : NewtonBase<Matrix, Vector>(linear_solver), eigen_solver_(eigen_solver), eps_(1e-12) {}
        ...
        bool solve(Function<Matrix, Vector> &fun, Vector &x) override {
            ...
            if (this->verbose()) PrintInfo::print_iter_status(it, {g_norm, energy_old, 0.0, tau, 0.0});
