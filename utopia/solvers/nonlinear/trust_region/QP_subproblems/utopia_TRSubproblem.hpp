...
class TRSubproblemBase : public virtual Configurable {
 public:
  ...
  void print_usage(std::ostream &os) const override {
    this->print_param_usage(os, "current_radius", "real",
                            "Value of trust region radius.", "1e14");
  }

 protected:
  Scalar quad_solver(const Vector &s, const Vector &p_k, const Scalar &delta,
                     Vector &result) {
...
class TRSubproblem : public virtual IterativeSolver<Matrix, Vector>,
