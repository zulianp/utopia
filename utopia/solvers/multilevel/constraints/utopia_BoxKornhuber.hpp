...
class BoxKornhuber : public MultilevelVariableBoundSolverInterface<
                         Matrix, Vector, BoxKornhuber<Matrix, Vector>> {
 public:
        ...
        for (auto i = rr.begin(); i != rr.end(); ++i) {
          ...
          for (auto index = 0; index < n_values; ++index) {
            ...
            if (rr_fine_level.inside(j)) {
              ...
              min_value =
                  (min_value < val_cons_fine_ub) ? min_value : val_cons_fine_ub;
            } else {
