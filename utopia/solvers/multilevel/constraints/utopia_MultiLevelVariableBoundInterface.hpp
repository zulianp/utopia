...
namespace utopia {
    ...
    public:
        ...
        const Vector &active_upper(const SizeType &level) { return static_cast<Child *>(this)->active_upper(level); }

        const Vector &active_lower(const SizeType &level) { return static_cast<Child *>(this)->active_lower(level); }
    ...
    public:
        ...
        void init_level(const SizeType &level,
