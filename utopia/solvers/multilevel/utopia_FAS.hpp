...
namespace utopia {
    ...
    public:
        FAS(const SizeType &n_levels, std::shared_ptr<Smoother> smoother, std::shared_ptr<Solver> coarse_solver)
        ...
        void print_usage(std::ostream &os) const override {
            ...
            this->print_param_usage(
                os, "smoother", "NonLinearSmoother", "Input parameters for fine level QP solver.", "-");
        }
