...
class IdentityTransfer final : public Transfer<Matrix, Vector> {
 ...
 public:
  ...
  bool project_down_positive_negative(const Vector &x_pos,
                                      const Vector & /*x_neg*/,
  ...
  Scalar interpolation_inf_norm() const override { return 1.0; }

  Scalar projection_inf_norm() const override { return 1.0; }

  Scalar restriction_inf_norm() const override { return 1.0; }
};
