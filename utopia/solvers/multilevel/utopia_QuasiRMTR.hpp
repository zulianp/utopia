...
class QuasiRMTR final : public RMTRBase<Matrix, Vector, FIRST_ORDER_DF> {
 ...
 public:
  ...
  void print_usage(std::ostream &os) const override {
    ...
    this->print_param_usage(os, "coarse-QPSolver", "MatrixFreeTRSubproblem",
                            "Input parameters for fine level QP solvers.", "-");
    this->print_param_usage(os, "fine-QPSolver", "MatrixFreeTRSubproblem",
 ...
 protected:
  ...
  bool solve_qp_subproblem(const SizeType &level, const bool &flg) override {
    ...
    tr_subproblems_[level]->solve(*multiplication_action,
