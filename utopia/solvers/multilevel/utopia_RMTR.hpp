    ...
    public:
        ...
        void read(Input &in) override {
            ...
            if (n_subproblems > 0) {
                ...
                for (std::size_t i = 1; i < n_subproblems; i++) in.get("fine-QPSolver", *_tr_subproblems[i]);
            }
        }
        ...
        void print_usage(std::ostream &os) const override {
            ...
            this->print_param_usage(
                os, "coarse-QPSolver", "TRSubproblem", "Input parameters for fine level QP solvers.", "-");
            this->print_param_usage(
                os, "fine-QPSolver", "TRSubproblem", "Input parameters for coarse level QP solver.", "-");
        }
