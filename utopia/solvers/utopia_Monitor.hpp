...
class Monitor {
 ...
 public:
   ...
   */
  virtual void init_solver(const std::string &method,
                           const std::vector<std::string> status_variables) = 0;
   ...
   */
  virtual void exit_solver(const SizeType &it,
                           const Scalar &convergence_reason) = 0;
   ...
   */
  virtual bool check_convergence(const SizeType &it, const Scalar &norm_grad,
