 ...
 public:
  MINRES() {
    static_assert(Backend < HOMEMADE,
                  "MINRES not implemented for this backend");
  }
};
...
class Factorization {
 public:
  Factorization() {
    static_assert(Backend < HOMEMADE,
                  "Factorization not implemented for this backend");
  }
};
...
class LUDecomposition {
 public:
  LUDecomposition() {
    static_assert(Backend < HOMEMADE,
                  "LUDecomposition not implemented for this backend");
  }
};
...
class CholeskyDecomposition {
 public:
  CholeskyDecomposition() {
    static_assert(Backend < HOMEMADE,
                  "CholeskyDecomposition not implemented for this backend");
  }
};
...
class RedundantLinearSolver {
 public:
  RedundantLinearSolver() {
    static_assert(Backend < HOMEMADE,
                  "RedundantLinearSolver not implemented for this backend");
  }
};
