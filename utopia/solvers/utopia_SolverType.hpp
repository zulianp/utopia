...
class Solver {
 public:
  ...
  inline constexpr static SolverType lu_decomposition() {
    return "lu_decomposition";
  }
  inline constexpr static SolverType cholesky_decomposition() {
  ...
  inline constexpr static SolverType steihaug_toint() {
    return "steihaug_toint";
  }
  ...
  // backtracking
  inline constexpr static SolverType simple_backtracking() {
